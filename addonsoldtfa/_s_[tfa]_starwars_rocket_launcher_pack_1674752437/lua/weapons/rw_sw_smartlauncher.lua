...
SWEP.IronSightsPos = Vector(-4.2, -6.5, -1.4)
...
SWEP.VElements = {
	...
	["scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_dlt19_reference001", rel = "sl", pos = Vector(07.3, -1.29, 14.095), angle = Angle(0, 180, 0), size = Vector(0.35, 0.35, 0.35), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
}

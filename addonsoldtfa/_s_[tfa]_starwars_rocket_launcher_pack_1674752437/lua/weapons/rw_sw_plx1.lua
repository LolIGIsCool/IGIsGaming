...
SWEP.IronSightsPos = Vector(-2.3, -2, -0.5)
SWEP.IronSightsAng = Vector(0, 0, 0)
SWEP.RunSightsPos = Vector(0.226, -2, 0)
...
SWEP.VElements = {
	["rocketlauncher"] = { type = "Model", model = "models/npc/bf2/republiclauncher.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(0, 10, 0), angle = Angle(0, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["scope1"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(7.35, -2.59, 7.21), angle = Angle(-90, 90, 0), size = Vector(0.02, 0.03, 0.03), color = Color(50, 255, 50, 255), surpresslightning = true, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
	["scope"] = { type = "Model", model = "models/hunter/tubes/tube1x1x1.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(7.35, -2.275, 7.21), angle = Angle(-90, 90, 0), size = Vector(0.005, 0.008, 0.008), color = Color(50, 255, 50, 255), surpresslightning = true, material = "models/debug/debugwhite", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["rocketlauncher"] = { type = "Model", model = "models/npc/bf2/republiclauncher.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(9, 1, -2), angle = Angle(0, 90, 192), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.ScopeReticule 					= "effects/tvscreen_noise003a" 
...
local g36
if surface then
	g36 = surface.GetTextureID("effects/tvscreen_noise003a") --the texture you vant to use
end

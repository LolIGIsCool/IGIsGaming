...
SWEP.IronSightsPos = Vector(-3.5, -4.5, 0.2)
...
SWEP.VElements = {
	["rocketlauncher"] = { type = "Model", model = "models/e60r/e-60r.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(-4, 35, 3), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["scope"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(2.1, 4.4, 6.9), angle = Angle(-90, 0, 90), size = Vector(0.038, 0.08, 0.02), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["rocketlauncher"] = { type = "Model", model = "models/e60r/e-60r.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(30, 0, -10), angle = Angle(0, -90, 170), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.ScopeReticule 					= "models/gtools_weapons/e60r_visor" 
SWEP.Secondary.ScopeZoom 			= 4
SWEP.ScopeReticule_Scale 			= {0.96,1.2}
if surface then
...
local g36
if surface then
	g36 = surface.GetTextureID("models/gtools_weapons/e60r_visor") --the texture you vant to use
end

...
SWEP.IronSightsPos = Vector(-5.2, -8, 2.8)
...
SWEP.VElements = {
	["dc15s"] = { type = "Model", model = "models/weapons/eabf2/npc/dp24.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(-4.2, 10, 1.5), angle = Angle(0, -90, 0), size = Vector(1.3, 1.3, 1.3), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/weapons/eabf2/dp24/rifle", skin = 0, bodygroup = {} },

}

SWEP.WElements = {
	["dc15s"] = { type = "Model", model = "models/weapons/eabf2/npc/dp24.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(9, -0.99, -3), angle = Angle(-13, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/weapons/eabf2/dp24/rifle", skin = 0, bodygroup = {} }
}

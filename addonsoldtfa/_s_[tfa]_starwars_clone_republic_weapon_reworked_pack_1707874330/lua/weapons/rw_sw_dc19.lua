...
SWEP.VElements = {
	["dc19"] = { type = "Model", model = "models/player/applesauce/228th/dc15s_carbine.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(-1.1, 2.2, 0), angle = Angle(0, -90, 0), size = Vector(1.3, 1.3, 1.3), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/applesauce/228th/dc15s/t_dc15a_cs", skin = 0, bodygroup = {[0] = 1, [1] = 1} },

...
SWEP.VElements = {
	...
	["trd"] = { type = "Model", model = "models/hunter/plates/plate025.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(1.84, 2.2, 04.3), angle = Angle(0, 0, 0), size = Vector(0.1, 0.25, 0.2), color = Color(255, 120, 0, 255), surpresslightning = true, material = "models/debug/debugwhite", skin = 0, bodygroup = {} }
}	

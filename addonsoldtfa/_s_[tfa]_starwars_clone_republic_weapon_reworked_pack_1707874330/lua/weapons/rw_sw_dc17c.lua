...
SWEP.IronSightsPos = Vector(-4.775, -10, 0.153)
...
SWEP.VElements = {
	["dc17"] = { type = "Model", model = "models/sw_battlefront/weapons/dc17_blaster.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-0.35, -0.32, 0.1), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["scope1"] = { type = "Model", model = "models/sw_battlefront/weapons/valken_scope.mdl", bone = "v_scoutblaster_reference001", rel = "dc17", pos = Vector(0, 0, 1), angle = Angle(0, 0, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["scope2"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_scoutblaster_reference001", rel = "dc17", pos = Vector(-1.5, 0, 5.188), angle = Angle(0, 180, 0), size = Vector(0.3, 0.3, 0.3), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["dc17"] = { type = "Model", model = "models/sw_battlefront/weapons/dc17_blaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.7, 1.2, -1.5), angle = Angle(180, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["scope"] = { type = "Model", model = "models/sw_battlefront/weapons/valken_scope.mdl", bone = "", rel = "dc17", pos = Vector(0, 0, 1), angle = Angle(0, 0, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

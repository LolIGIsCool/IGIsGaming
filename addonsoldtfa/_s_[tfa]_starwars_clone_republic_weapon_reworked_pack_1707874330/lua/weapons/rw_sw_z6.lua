...
SWEP.Primary.RPM 					= 610
SWEP.Primary.RPM_max                = 610
...
SWEP.VElements = {
	["z6"] = { type = "Model", model = "models/sw_battlefront/weapons/z6_rotary_cannon.mdl", bone = "v_t21_reference001", rel = "", pos = Vector(0.75, 0, 1), angle = Angle(0, -90, 0), size = Vector(1.2, 1.1, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}	

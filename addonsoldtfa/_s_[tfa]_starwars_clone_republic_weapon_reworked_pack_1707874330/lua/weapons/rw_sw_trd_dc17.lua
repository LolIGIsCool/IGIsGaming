...
SWEP.VElements = {
	...
	["trd"] = { type = "Model", model = "models/hunter/tubes/circle2x2.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(-0.35, 2.64, 1.878), angle = Angle(0, 0, 90), size = Vector(0.014, 0.014, 0.014), color = Color(255, 120, 0, 255), surpresslightning = true, material = "models/debug/debugwhite", skin = 0, bodygroup = {} }
}

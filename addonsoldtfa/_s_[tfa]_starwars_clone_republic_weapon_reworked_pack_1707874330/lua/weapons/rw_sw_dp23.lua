...
SWEP.IronSightsPos = Vector(-4.8, -4, 1.5)
...
SWEP.VElements = {
	["dp23"] = { type = "Model", model = "models/sw_battlefront/weapons/2019/dp23_base.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(1.2, -0.5, -6.5), angle = Angle(0, -90, 0), size = Vector(1.2, 1.1, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 0, [2] = 1, [3] = 1} }
}	

SWEP.WElements = {
	["dp23"] = { type = "Model", model = "models/sw_battlefront/weapons/2019/dp23_base.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5.5, 0.5, 4.5), angle = Angle(-12, 0, 172), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 0, [2] = 1, [3] = 1} }
}

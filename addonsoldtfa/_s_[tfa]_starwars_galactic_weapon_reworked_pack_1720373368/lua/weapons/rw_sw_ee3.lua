...
SWEP.VMPos = Vector(1.97, -2.814, -0.56)
...
SWEP.IronSightsPos = Vector( -5.6, -4, 0.8)
...
SWEP.VElements = {
    ["ee3"] = { type = "Model", model = "models/sw_battlefront/weapons/ee3_carbine.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(0, 0.5, -0.5), angle = Angle(0, -90, 0), size = Vector(1.4, 1.4, 1.4), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
    ["scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_dlt19_reference001", rel = "ee3", pos = Vector(1.6, 0, 6.385), angle = Angle(0, 180, 0), size = Vector(0.3, 0.3, 0.3), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}

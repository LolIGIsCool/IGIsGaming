...
SWEP.VMPos = Vector(0.91, -4, -0.175)
...
SWEP.IronSightsPos = Vector(-4.575, -9, 2.55)
...
SWEP.VElements = {
	["d30"] = { type = "Model", model = "models/sw_battlefront/weapons/2019/defender_base.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-0.5, 0, 0), angle = Angle(0, 90, -1.5), size = Vector(1.05, 1.05, 1.05), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

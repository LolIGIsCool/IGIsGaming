...
SWEP.Primary.RPM_max                = 940
SWEP.Primary.RPM_Burst				= 940
...
SWEP.VElements = {
	["z6"] = { type = "Model", model = "models/sw_battlefront/weapons/z6_rotary_cannon.mdl", bone = "v_t21_reference001", rel = "", pos = Vector(0.75, 0, 1), angle = Angle(0, -90, 0), size = Vector(1.2, 1.1, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/sw_battlefront/weapons/z6rc/t_z6rotary_skin_cs", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["z6"] = { type = "Model", model = "models/sw_battlefront/weapons/z6_rotary_cannon.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4, 1, 1), angle = Angle(-6, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/sw_battlefront/weapons/z6rc/t_z6rotary_skin_cs", skin = 0, bodygroup = {} }
}

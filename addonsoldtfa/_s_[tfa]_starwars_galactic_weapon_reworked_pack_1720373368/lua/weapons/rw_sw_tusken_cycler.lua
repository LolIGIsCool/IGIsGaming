...
SWEP.VMPos = Vector(3.026, -2, 0.055)
...
SWEP.Primary.SpreadMultiplierMax 	= 0.0
...
SWEP.IronSightsPos = Vector(-8.1, -13, 2.2)
...
SWEP.VElements = {
	["tcr"] = { type = "Model", model = "models/sw_battlefront/weapons/tusken_cycler_rifle.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(0, -1, 1.5), angle = Angle(0, -90, 0), size = Vector(1.2, 1.1, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },

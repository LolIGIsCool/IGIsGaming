...
SWEP.PrintName						= "Mandalorian Hand-Rocket"
SWEP.Type							= "Galactic Mandalorian Hand Rocket"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.Primary.Sound 					= Sound ("weapons/e5.wav");
SWEP.Primary.ReloadSound 			= Sound ("weapons/pistols.wav");
...
SWEP.VElements = {
	["b2rph"] = { type = "Model", model = "models/hunter/misc/roundthing4.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(2.85, -6, 5), angle = Angle(90, 0, 0), size = Vector(0.12, 0.12, 0.12), color = Color(75, 75, 75, 255), surpresslightning = false, material = "models/debug/debugwhite", skin = 0, bodygroup = {} },
	...
	["b2rpr"] = { type = "Model", model = "models/rocket/rocket_v1.mdl", bone = "v_scoutblaster_reference001", rel = "b2rph", pos = Vector(5, 2, 2.88), angle = Angle(0, 90, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

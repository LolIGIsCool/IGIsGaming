...
SWEP.IronSightsPos = Vector(-6, -8, 2.8)
...
SWEP.VElements = {
	["d"] = { type = "Model", model = "models/sw_battlefront/weapons/defender_sporting_pistol.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(0.1, -1, -.35), angle = Angle(0, 90, 0), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["d"] = { type = "Model", model = "models/sw_battlefront/weapons/defender_sporting_pistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.2, 1, -1.8), angle = Angle(0, -2, 177), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

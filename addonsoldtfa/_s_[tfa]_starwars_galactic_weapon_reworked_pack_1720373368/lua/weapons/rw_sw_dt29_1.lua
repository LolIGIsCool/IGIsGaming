...
SWEP.Primary.Sound 					= Sound ("w/dt29-4.wav");
...
SWEP.IronSightsPos = Vector(-5.7, -14, 2.45)
...
SWEP.VElements = {
	["dt26"] = { type = "Model", model = "models/swbf/weapons/dt-29 heavy blaster pistol.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-0.8, 0, 0), angle = Angle(0, 90, 0), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["scope1"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_scoutblaster_reference001", rel = "dt26", pos = Vector(1.92,1.489,3.24), angle = Angle(175, 0,-180), size = Vector(0.21, 0.21, 0.21), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["dt26"] = { type = "Model", model = "models/swbf/weapons/dt-29 heavy blaster pistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.5, 1.2, -1.7), angle = Angle(0, 0, 180), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
local g36
if surface then
	g36 = surface.GetTextureID("#sw/visor/sw_ret_redux_purple") --the texture you vant to use
end

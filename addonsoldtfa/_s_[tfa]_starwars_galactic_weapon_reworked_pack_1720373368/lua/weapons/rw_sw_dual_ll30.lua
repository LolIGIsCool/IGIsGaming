...
SWEP.Primary.RPM					= 330*2
SWEP.Primary.RPM_Burst				= 330*2
...
SWEP.VElements = {
	["rk3"] = { type = "Model", model = "models/weapons/w_LL30.mdl", bone = "LeftHand_1stP", rel = "", pos = Vector(12, 3, -2), angle = Angle(-5, 0, 80), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["rk3+"] = { type = "Model", model = "models/weapons/w_LL30.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(-12, -3, 0.5), angle =  Angle(180, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}


SWEP.WElements = {
	["rk3"] = { type = "Model", model = "models/weapons/w_LL30.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(11, 2, 3), angle = Angle(0,-5,0), size = Vector(0.9,0.9,0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["rk3+"] = { type = "Model", model = "models/weapons/w_LL30.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(9.5, 2, -2.5), angle = Angle(0,-12,180), size = Vector(0.9,0.9,0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

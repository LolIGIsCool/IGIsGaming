...
SWEP.Primary.IronAccuracy 			= 0.0035
...
SWEP.IronSightsPos = Vector(-3.85, 1.65, 2.15)
...
SWEP.WElements = {
	["dc15a"] = { type = "Model", model = "models/sw_battlefront/weapons/dc15a_rifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.3, 1.3, -1.4), angle = Angle(-13, 0, 180), size = Vector(1, 1, 1), color = Color(100, 100, 100, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 0, [2] = 1, [3] = 1} }
}

...
SWEP.IronSightsPos = Vector(-4.5, -4, 2.6)
...
SWEP.VElements = {
    ["t21b"] = { type = "Model", model = "models/hauptmann/star wars/weapons/t21b.mdl", bone = "v_t21_reference001", rel = "", pos = Vector(-0.8, 10, -6), angle = Angle(0, -90, 0), size = Vector(1.4, 1.4, 1.4), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_t21_reference001", rel = "t21b", pos = Vector(-7.5, -1.62, 15.45), angle = Angle(0, 180, 0), size = Vector(0.4, 0.4, 0.4), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
	["scope2"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_t21_reference001", rel = "t21b", pos = Vector(1.883, 2.45, 10.8), angle = Angle(0, 90, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
    ["t21b"] = { type = "Model", model = "models/hauptmann/star wars/weapons/t21b.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(10.8, 0.2, 2.5), angle = Angle(0, 0, 169), size = Vector(0.9, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
function SWEP:Think()
	if self.Owner:GetNWBool("CamoEnabled") then
		self:GetOwner():GetActiveWeapon():SetNoDraw(true)
	else
		self:GetOwner():GetActiveWeapon():SetNoDraw(false)
	end
end
...
SWEP.IronSightsPos = Vector(-5.8, -6, 1)
...
SWEP.VElements = {
	["t21"] = { type = "Model", model = "models/kuro/sw_battlefront/weapons/bf1/t21.mdl", bone = "v_t21_reference001", rel = "", pos = Vector(0.6, 1.5, -1.6), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}	

...
SWEP.VElements = {
	["e11"] = { type = "Model", model = "models/bailey/e11/e11_epicallycoolskin.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(-1, 7, -4.3), angle = Angle(0, -90, 0), size = Vector(1.3, 1.3, 1.3), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 10, bodygroup = {} },
...
SWEP.WElements = {
	["e11"] = { type = "Model", model = "models/bailey/e11/e11_epicallycoolskin.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(10, 0.4, 1), angle = Angle(192, 180, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 10, bodygroup = {} }
}

...
SWEP.VElements = {
	["tl50"] = { type = "Model", model = "models/sw_battlefront/weapons/tl50_repeater.mdl", bone = "v_t21_reference001", rel = "", pos = Vector(1.2, 4, 0.5), angle = Angle(0, -90, 0), size = Vector(1.2, 1.1, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1, [2] = 0, [3] = 0} }
}	

...
SWEP.VElements = {
	["e10"] = { type = "Model", model = "models/banks/e-10/e-10_blaster.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(-1.14, 7, -3), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["e10"] = { type = "Model", model = "models/banks/e-10/e-10_blaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(8.6,1.16,2.1), angle = Angle(192, 180, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

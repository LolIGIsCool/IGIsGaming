...
SWEP.PrintName				= "Cyrothrower"		-- Weapon name (Shown on HUD)
SWEP.Slot				= 2				-- Slot in the weapon selection menu.  Subtract 1, as this starts at 0.
SWEP.SlotPos				= 73			-- Position in the slot
SWEP.AutoSwitchTo			= true		-- Auto switch to if we pick it up
SWEP.AutoSwitchFrom			= true		-- Auto switch from if you pick up a better weapon
SWEP.Weight				= 30			-- This controls how "good" the weapon is for autopickup.
SWEP.Type 	= 	"Cyrothrower"
SWEP.FireModeName = "Cyrothrower"
...
SWEP.Primary.Ammo = "heavy_battery" -- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
--[2] = etc.
--}
SWEP.DefaultHoldType = "crossbow" -- This is how others view you carrying the weapon. Options include:
...
PrecacheParticleSystem("flamethrower_halloween_crit_blue")
...
function SWEP:Think2( ... )
	...
	if shooting ~= self.Shooting_Old then
		if shooting then
			...
			fx:SetEntity(self)
			fx:SetAttachment(1)
			util.Effect("waw_flame_blue",fx)
			if self:IsFirstPerson() then
				ParticleEffectAttach("flamethrower_halloween_crit_blue",PATTACH_POINT_FOLLOW,self.OwnerViewModel,1)
			else
				ParticleEffectAttach("flamethrower_halloween_crit_blue",PATTACH_POINT_FOLLOW,self,1)
			end

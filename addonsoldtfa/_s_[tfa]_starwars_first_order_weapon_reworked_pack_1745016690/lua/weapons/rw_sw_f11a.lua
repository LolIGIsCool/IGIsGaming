...
SWEP.IronSightsPos = Vector(-5.5, 01, 2.5)
...
SWEP.VElements = {
	["f11"] = { type = "Model", model = "models/sw_battlefront/weapons/f11d_ext.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(-0.4, -2, 2), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0]=1,[1]=1,[2]=1,[3]=1,[4]=1,[5]=1,[7]=0}},
}	

SWEP.WElements = {
	["f11"] = { type = "Model", model = "models/sw_battlefront/weapons/f11d_ext.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 0.4, -2), angle = Angle(-13, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0]=1,[1]=1,[2]=1,[3]=1,[4]=1,[5]=1,[7]=0}},
}

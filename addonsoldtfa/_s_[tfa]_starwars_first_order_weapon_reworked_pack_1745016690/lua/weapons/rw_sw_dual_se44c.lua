...
SWEP.Primary.Sound 					= Sound ("w/se44c.wav");
...
SWEP.VElements = {
	["dc17"] = { type = "Model", model = "models/markus/fo_se44_blaster_pistol/fo_se44_blaster_pistol_white.mdl", bone = "LeftHand_1stP", rel = "", pos = Vector(4, 3, -1), angle = Angle(-12, -2, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["dc17+"] = { type = "Model", model = "models/markus/fo_se44_blaster_pistol/fo_se44_blaster_pistol_white.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(-4, -3, 1), angle = Angle(8, 178, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}


SWEP.WElements = {
	["dc17"] = { type = "Model", model = "models/markus/fo_se44_blaster_pistol/fo_se44_blaster_pistol_white.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(3.7, 1, 1.8), angle = Angle(0, -10, 2), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["dc17+"] = { type = "Model", model = "models/markus/fo_se44_blaster_pistol/fo_se44_blaster_pistol_white.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.7, 1, -1.8), angle = Angle(0, -8, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

...
SWEP.IronSightsPos = Vector(-4.2, -1, -0.5)
...
SWEP.VElements = {
    ...
    ["scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_dlt19_reference001", rel = "dlt19d", pos = Vector(-1.451, 4.4, 7.72), angle = Angle(0, -90, 0), size = Vector(0.35, 0.35, 0.35), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}

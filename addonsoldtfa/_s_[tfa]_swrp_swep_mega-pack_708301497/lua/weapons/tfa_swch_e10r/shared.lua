...
if ( CLIENT ) then
	...
	SWEP.Slot				= 2
	SWEP.SlotPos			= 3
	SWEP.WepSelectIcon 		= surface.GetTextureID("vgui/hud/weapon_e10r")
	
	killicon.Add( "weapon_752bf3_e11", "HUD/killicons/E11", Color( 255, 80, 0, 255 ) )
...
SWEP.ViewModel				= "models/weapons/e10r/c_E10R.mdl"
SWEP.WorldModel				= "models/weapons/e10r/w_E10R.mdl"

SWEP.Weight					= 5
SWEP.AutoSwitchTo			= false
SWEP.AutoSwitchFrom			= false

SWEP.Primary.Sound = Sound ("weapons/e10r/e10r_fire.wav");
SWEP.Primary.ReloadSound = Sound ("weapons/e10r/e10r_reload.wav");
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_weapon.famas", rel = "", pos = Vector(-9.931, -2.225, 0.28), angle = Angle(0, -180, 0), size = Vector(0.18, 0.18, 0.18), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}

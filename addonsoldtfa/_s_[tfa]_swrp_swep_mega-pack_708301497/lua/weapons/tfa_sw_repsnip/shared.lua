...
SWEP.Primary.StaticRecoilFactor = 0.005 	--Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.

--Firing Cone Related

SWEP.Primary.Spread		= .00005					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
SWEP.Callback.ChooseProceduralReloadAnim = function(self)
	self:EmitSound("TFA_SW_REPSNIP.Reload")
end

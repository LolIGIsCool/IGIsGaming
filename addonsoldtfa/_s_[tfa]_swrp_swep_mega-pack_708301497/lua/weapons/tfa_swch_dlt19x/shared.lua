...
if ( CLIENT ) then
	...
	SWEP.Slot				= 2
	SWEP.SlotPos			= 3
	SWEP.WepSelectIcon 		= surface.GetTextureID("HUD/killicons/dlt20a")
	
	killicon.Add( "weapon_752bf3_dlt20a", "HUD/killicons/dlt20a", Color( 255, 80, 0, 255 ) )
...
SWEP.ViewModel				= "models/weapons/banks/dlt19x.mdl"
SWEP.WorldModel				= "models/weapons/banks/dlt19x.mdl"
...
SWEP.Primary.Spread			= 0.00000001

...
if ( CLIENT ) then
	...
	SWEP.Author				= "Sav ported to TFA :)"
	SWEP.ViewModelFOV		= 50
	SWEP.Slot				= 2
	SWEP.SlotPos			= 3
	SWEP.WepSelectIcon 		= surface.GetTextureID("HUD/killicons/dh17")
	
	killicon.Add( "weapon_752bf3_dh17", "HUD/killicons/dh17", Color( 255, 80, 0, 255 ) )
...
SWEP.Primary.Sound = Sound ("weapons/dh17_fire.wav");
SWEP.Primary.ReloadSound = Sound ("weapons/dh17_reload.wav");

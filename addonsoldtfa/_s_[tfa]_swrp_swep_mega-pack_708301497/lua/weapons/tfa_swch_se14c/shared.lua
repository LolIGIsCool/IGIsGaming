...
if ( CLIENT ) then
	...
	killicon.Add( "weapon_752bf3_se14c", "HUD/killicons/se14c", Color( 255, 80, 0, 255 ) )
...
SWEP.Primary.Sound = Sound ("weapons/se14c_fire.wav");
SWEP.Primary.ReloadSound = Sound ("weapons/se14c_reload.wav");

SWEP.Primary.Recoil			= 1.3
SWEP.Primary.Damage			= 20
SWEP.Primary.NumShots			= 5
SWEP.Primary.Cone			= 0.0390
SWEP.Primary.ClipSize			= 15
SWEP.Primary.RPM = 60/0.5

...
SWEP.ViewModel				= "models/weapons/banks/c_skin/c_super.mdl"
SWEP.WorldModel				= "models/weapons/banks/w_skin/w_super.mdl"
...
SWEP.Primary.ReloadSound = Sound ("weapons/e11_reload.wav");
...
trsw = { "effect_sw_laser_purple", "effect_sw_laser_green" }
--it = 1
SWEP.ThinkRate = 1/25
function SWEP:Think()
	if it == 1 then

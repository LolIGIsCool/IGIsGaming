...
SWEP.VElements = {
	["n"] = { type = "Model", model = "models/weapons/tfa_starwars/w_smoke.mdl", bone = "Weapon_F1", rel = "", pos = Vector(0, 0, 2), angle = Angle(0, -70, 90), size = Vector(0.7, 0.7, 0.7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["n"] = { type = "Model", model = "models/weapons/tfa_starwars/w_smoke.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(03.2, 02.2, -01), angle = Angle(0, 110, 0), size = Vector(0.9, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

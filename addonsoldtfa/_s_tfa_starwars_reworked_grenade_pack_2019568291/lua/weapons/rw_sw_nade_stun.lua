...
SWEP.Primary.Sound 				= Sound ("weapons/tfa_csgo/hegrenade/grenade_throw.wav");
...
SWEP.VElements = {
	["n"] = { type = "Model", model = "models/weapons/tfa_starwars/w_flash.mdl", bone = "Weapon_F1", rel = "", pos = Vector(-0.2, -0.1, 01.1), angle = Angle(-05, -170, 0), size = Vector(0.6, 0.6, 0.6), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["n"] = { type = "Model", model = "models/weapons/tfa_starwars/w_flash.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(03, 02, 0), angle = Angle(10, -90, 0), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

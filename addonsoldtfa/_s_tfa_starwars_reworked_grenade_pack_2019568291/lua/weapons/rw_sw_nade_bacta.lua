...
SWEP.VElements = {
	["n"] = { type = "Model", model = "models/forrezzur/bactagrenade.mdl", bone = "Weapon_F1", rel = "", pos = Vector(-0.7, 0.2, 01.1), angle = Angle(10, -90, 90), size = Vector(0.7, 0.7, 0.7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["n"] = { type = "Model", model = "models/forrezzur/bactagrenade.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(03, 02, 0), angle = Angle(10, 30, 260), size = Vector(0.9, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

...
hook.Add( "PlayerSwitchWeapon", "FixGrenadeExploit", function( ply, oldWeapon, newWeapon )
	if oldWeapon.Base == "tfa_ins2_nade_base" and (oldWeapon:GetNW2Bool( "Cooking", false ) or oldWeapon:GetNW2Bool( "Pulling", false )) then
		oldWeapon.cancelthrow = true
	end
end )
...
function SWEP:ShootBullet(damage, recoil, num_bullets, aimcone, disablericochet, bulletoverride)
	...
	if SERVER then
		if self.cancelthrow then return end
		local ent = ents.Create(self.Primary.Round)
		local dir

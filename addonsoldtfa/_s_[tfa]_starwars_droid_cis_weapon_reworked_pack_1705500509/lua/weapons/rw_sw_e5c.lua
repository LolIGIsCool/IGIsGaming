...
SWEP.IronSightsPos = Vector(-5.22, -2, 0.95)
SWEP.IronSightsAng = Vector(0, 0, 0)
SWEP.RunSightsPos = Vector(5, 0, 1)
...
SWEP.VElements = {
	["e5c"] = { type = "Model", model = "models/kuro/sw_battlefront/weapons/e5c_blaster.mdl", bone = "v_t21_reference001", rel = "", pos = Vector(0.699, 2, -2.8), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

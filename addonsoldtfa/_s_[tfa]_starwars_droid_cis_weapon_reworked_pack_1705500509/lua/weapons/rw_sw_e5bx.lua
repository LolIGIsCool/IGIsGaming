...
SWEP.VMPos = Vector(1.240, -3.819, -0.160)
...
SWEP.IronSightsPos = Vector(-4.1, 0, 1)
...
SWEP.VElements = {
	["e5"] = { type = "Model", model = "models/kuro/sw_battlefront/weapons/e5_blaster.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(-0.95, 0.899, -3.5), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/kuro/sw_battlefront/weapons/e5/t_e5_cs_b", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["e5"] = { type = "Model", model = "models/kuro/sw_battlefront/weapons/e5_blaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5, 1, 2), angle = Angle(-8, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/kuro/sw_battlefront/weapons/e5/t_e5_cs_b", skin = 0, bodygroup = {} }
}

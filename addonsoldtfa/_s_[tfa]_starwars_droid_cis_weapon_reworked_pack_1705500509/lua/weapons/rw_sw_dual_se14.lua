...
SWEP.VElements = {
	["se14c"] = { type = "Model", model = "models/sw_battlefront/weapons/2019/se14_pistol.mdl", bone = "LeftHand_1stP", rel = "", pos = Vector(05, -1.5, -0.75), angle = Angle(-4, -2, 90), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["se14c+"] = { type = "Model", model = "models/sw_battlefront/weapons/2019/se14_pistol.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(-5, 1.5, 0.75), angle = Angle(2, 178, 90), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

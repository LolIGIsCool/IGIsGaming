...
SWEP.VMPos = Vector(1.945, -2.814, -0.56)
...
SWEP.IronSightsPos = Vector(-5.9, -13.5, 1.8)
...
SWEP.VElements = {
	...
	["scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_scoutblaster_reference001", rel = "rg4d", pos = Vector(-3.565, 0, 6.905), angle = Angle(0, 180, 0), size = Vector(0.27, 0.27, 0.27), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}

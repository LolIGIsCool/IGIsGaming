...
SWEP.Primary.RPM					= 270*2
SWEP.Primary.RPM_Burst				= 320*2
...
SWEP.VElements = {
	["e5"] = { type = "Model", model = "models/kuro/sw_battlefront/weapons/e5_blaster.mdl", bone = "LeftHand_1stP", rel = "", pos = Vector(4, -1.5, -1), angle = Angle(-4, -2, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/kuro/sw_battlefront/weapons/e5/t_e5_cs_b", skin = 0, bodygroup = {} },
	["e5+"] = { type = "Model", model = "models/kuro/sw_battlefront/weapons/e5_blaster.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(-4, 1.5, 1), angle = Angle(2, 178, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/kuro/sw_battlefront/weapons/e5/t_e5_cs_b", skin = 0, bodygroup = {} }
}


SWEP.WElements = {
	["e5"] = { type = "Model", model = "models/kuro/sw_battlefront/weapons/e5_blaster.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(4, 1.2, -2), angle = Angle(0, -10, 2), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/kuro/sw_battlefront/weapons/e5/t_e5_cs_b", skin = 0, bodygroup = {} },
	["e5+"] = { type = "Model", model = "models/kuro/sw_battlefront/weapons/e5_blaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4, 1.2, 2), angle = Angle(0, -9, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/kuro/sw_battlefront/weapons/e5/t_e5_cs_b", skin = 0, bodygroup = {} }
}

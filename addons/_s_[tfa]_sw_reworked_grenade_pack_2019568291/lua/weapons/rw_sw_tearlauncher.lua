...
SWEP.PrintName						= "Tear Gas Launcher"
SWEP.Type							= "Tear Gas Launcher"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.ProjectileVelocity 			= 650*2
SWEP.ProjectileEntity               = "rw_sw_ent_nade_tear"

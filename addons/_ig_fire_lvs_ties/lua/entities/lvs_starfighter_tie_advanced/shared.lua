...
ENT.Author = "Fire"
ENT.Information = "Vader's shitty combustion box"
...
function ENT:InitWeapons()
	...
	weapon.Attack = function( ent )
		...
		for i = -1,1,2 do
			local Pos = ent:LocalToWorld(Vector(49.91, 14.53 * i, -42.09))
			...
			projectile:SetAngles( ent:GetForward():Angle() )

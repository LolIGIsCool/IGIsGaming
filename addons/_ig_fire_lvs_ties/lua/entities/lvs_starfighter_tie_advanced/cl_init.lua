...
function ENT:OnSpawn()
    self:RegisterTrail( Vector(-39.84,-33.12,19.12), 0, 20, 2, 1000, 150 )
    self:RegisterTrail( Vector(-39.84,33.12,19.12), 0, 20, 2, 1000, 150 )
    self:RegisterTrail( Vector(-39.84,-33.12,-19.12), 0, 20, 2, 1000, 150 )
    self:RegisterTrail( Vector(-39.84,33.12,-19.12), 0, 20, 2, 1000, 150 )
end
...
function ENT:EngineEffects()
    ...
    for i = -1,1,2 do
        for ii = -1,1,2 do
            local vOffset = self:LocalToWorld(Vector(-39.84, 33.12 * i, 19.12 * ii))
...
function ENT:PostDrawTranslucent()
	...
	for i = -1,1,2 do
        for ii = -1,1,2 do
            local pos = self:LocalToWorld( Vector(-39.84, 33.12 * i, 19.12 * ii) )

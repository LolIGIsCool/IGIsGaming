...
ENT.Spawnable = false
ENT.PrintName = "Sneaky's Jumppack"
...
function ENT:Initialize()
	...
	if SERVER then
		...
		self:SetFuelDrain(0.69)	--drain in seconds
		self:SetFuelRecharge(3)	--recharge in seconds
		self:SetActive( false )
		self:SetCanStomp( false )
		self:SetDoGroundSlam( false )
		self:SetAirResistance( 7 )
		self:SetRemoveGravity( true )
		self:SetJetpackSpeed( 10000 )
		self:SetJetpackStrafeSpeed( 1200 )
		self:SetJetpackVelocity( 2400 )
		self:SetJetpackStrafeVelocity( 10000 )
	else

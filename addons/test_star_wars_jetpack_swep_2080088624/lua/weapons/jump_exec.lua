...
function SWEP:PrimaryAttack()
	...
	if IsValid(ex) then
		...
		local jp = ents.Create('sneakyjumppack')
		jp:SetSlotName('sneakyjumppack')
		jp:Spawn()
		jp:Attach(ply)
		ply.Jetted = jp
...
hook.Add("GetFallDamage", "DarkTrooperFall", function(ply, fallSpeed)
    print(fallSpeed)
	if ply:GetRegiment() == "Phase Zero Dark Trooper" && fallSpeed < 900 then return 0 end
end)

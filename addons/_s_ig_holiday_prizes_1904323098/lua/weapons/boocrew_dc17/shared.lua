...
SWEP.VElements = {
	["dc17"] = { type = "Model", model = "models/bailey/boocrew_dc17/boocrew_dc17.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-0.3, 0, 0), angle = Angle(0, -180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["dc17"] = { type = "Model", model = "models/bailey/boocrew_dc17/boocrew_dc17.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4, 1, -1.3), angle = Angle(0, -90, 170), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

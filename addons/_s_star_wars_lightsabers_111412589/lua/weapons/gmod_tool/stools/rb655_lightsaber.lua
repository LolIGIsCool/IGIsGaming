...
TOOL.ClientConVar["red1"] = "0"
TOOL.ClientConVar["green1"] = "127"
TOOL.ClientConVar["blue1"] = "255"
...
list.Set( "LightsaberModels", "models/dante/dante.mdl", {} )
list.Set( "LightsaberModels", "models/borth-twin/borth-twin.mdl", {} )
...
list.Set( "LightsaberModels", "models/dylanxd/dylanxd.mdl", {} )
...
list.Set( "LightsaberModels", "models/sgg/starwars/weapons/w_kyle_saber_hilt.mdl", {} )
...
list.Set( "LightsaberModels", "models/twinsaber/twinsaber.mdl", {} )
list.Set( "LightsaberModels", "models/unknown/unknown.mdl", {} )
...
list.Set( "LightsaberModels", "models/the grand saber/the grand saber.mdl", {} ) -- zaspan
list.Set( "LightsaberModels", "models/star/venator/inqusitor_saber.mdl", {} ) -- zaspan
...
function TOOL.BuildCPanel( panel )
	...
	panel:AddControl( "Color", { Label = "1st Crystal Colour", Red = "rb655_lightsaber_red", Green = "rb655_lightsaber_green", Blue = "rb655_lightsaber_blue", ShowAlpha = "0", ShowHSV = "1", ShowRGB = "1" } )
	panel:AddControl( "Color", { Label = "2nd Crystal Colour", Red = "rb655_lightsaber_red1", Green = "rb655_lightsaber_green1", Blue = "rb655_lightsaber_blue1", ShowAlpha = "0", ShowHSV = "1", ShowRGB = "1" } )

...
SWEP.IronSightsPos = Vector(-4.92, -7, 3.455)
...
SWEP.VElements = {
	["e10r"] = { type = "Model", model = "models/banks/e-10r/e-10r_blaster.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(-1, 6, -3), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_e11_reference001", rel = "e10r", pos = Vector(4.65, -0.16, 7.06), angle = Angle(0, -180, 0), size = Vector(0.34, 0.34, 0.34), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["e10r"] = { type = "Model", model = "models/banks/e-10r/e-10r_blaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(10, 0.4, 1), angle = Angle(192, 180, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

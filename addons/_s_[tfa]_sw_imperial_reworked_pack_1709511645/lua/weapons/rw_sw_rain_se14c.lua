...
SWEP.VElements = {
    ["se14c"] = { type = "Model", model = "models/hauptmann/star wars/weapons/se14c.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(0, 0, -4.5), angle = Angle(0, 90, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/rainbow/hull_gay", skin = 0, bodygroup = {} },
...
SWEP.WElements = {
	["se14c"] = { type = "Model", model = "models/hauptmann/star wars/weapons/se14c.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4, 1.5, 2.9), angle = Angle(-8, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/rainbow/hull_gay", skin = 0, bodygroup = {} }
}

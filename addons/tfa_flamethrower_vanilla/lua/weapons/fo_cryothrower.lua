SWEP.NZPaPName = "Cryothrower"
SWEP.Base				= "tfa_gun_base"
SWEP.Category				= "TFA VANILLA"
SWEP.Author				= "VANILAL!!!ASD"
SWEP.Contact				= "dignle is gay"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.DrawCrosshair			= true
SWEP.DrawCrosshairIS = false
SWEP.PrintName				= "[DO NOT USE] Cryothrower"
SWEP.Slot				= 4
SWEP.SlotPos				= 1
...
function SWEP:Think2( ... )
	...
	if shooting ~= self.Shooting_Old then
		if shooting then
			...
			fx:SetEntity(self)
			fx:SetAttachment(1)
			util.Effect("flamethrower_halloween_crit_blue",fx)
			--[[

...
SWEP.PrintName						= "DLT-19 [Dark Trooper]"
...
SWEP.IronSightsPos = Vector(-3.1, -5, 1.4)
...
SWEP.VElements = {
	["dc15a"] = { type = "Model", model = "models/kuro/sw_battlefront/weapons/bf1/dlt19.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(0.5, -1, -4), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}	

SWEP.WElements = {
	["dc15a"] = { type = "Model", model = "models/kuro/sw_battlefront/weapons/bf1/dlt19.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.5, 0.5, 3), angle = Angle(-13, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

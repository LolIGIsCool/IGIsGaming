...
SWEP.PrintName						= "RT-97c Suppression"
...
SWEP.JumpAccuracyMultiplier			= 0.8
...
SWEP.Primary.SpreadIncrement 		= 10
...
SWEP.VElements = {
    ["rt97c"] = { type = "Model", model = "models/sw_battlefront/weapons/rt97c_noscope.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(0, 18, -5.5), angle = Angle(0, -90, 0), size = Vector(1.4, 1.4, 1.4), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
    ["rt97c"] = { type = "Model", model = "models/sw_battlefront/weapons/rt97c_noscope.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(18.5, 1, -1), angle = Angle(-11, 0, 175), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

...
local IsValidCuffTarget = function(ply, target)
	if hook.Run("CrixCheckCuffStatus", target) then 
		return true 
	else  
		ply:PrintMessage(HUD_PRINTTALK, "EM has toggled cuffing of EC's off")
		return false
	end
end
...
function SWEP:PrimaryAttack()
	...
	if IsValidCuffTarget(self:GetOwner() , tr.Entity) == false then return end 

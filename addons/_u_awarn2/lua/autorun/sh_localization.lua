...
AWarn.localizations["ES"] = {
	...
	cl26	=		"Permitir que AWarn KICK jugadores (definidos en el archivo de configuración de castigo)", --Encontrado en cl_init.lua
	cl27	=		"Permita que AWarn BAN jugadores (definidos en el archivo de configuración de castigo)", --Encontrado en cl_init.lua

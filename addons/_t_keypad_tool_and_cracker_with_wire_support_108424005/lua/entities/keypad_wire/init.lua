...
util.AddNetworkString("Keypad_Wirenet")

net.Receive("Keypad_Wire", function(_, ply)
-- actual baited retard
	gBan:PlayerBanID( nil, ply:SteamID(), 0, "Automatically banned for exploiting.", false )
end)

net.Receive("Keypad_Wirenet", function(_, ply)

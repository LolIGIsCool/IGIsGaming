...
SimpleXPConfig.DefaultFolder = "simplexp"
...
SimpleXPConfig.DisplayHints = false
--Values: true, false
...
--SimpleXPConfig.DefaultGreen = 255 --- Disabled for halloween
SimpleXPConfig.DefaultGreen = 160
--SimpleXPConfig.DefaultBlue = 255 --- Disabled for halloween
SimpleXPConfig.DefaultBlue = 0
...
SimpleXPConfig.WeekdayScale = 1 -- was 1
...
SimpleXPConfig.WeekendScale = 2 -- was 2
-- Values: Any real positive number.
...
SimpleXPConfig.GiveXPOnTimeDelay = 300
...
SimpleXPConfig.NpcKillsBase = 10
-- Values: Any real number
-- Base XP given to the player for killing an NPC

SimpleXPConfig.NpcMaxHealth = 2
-- Values: Any real number
...
SimpleXPConfig.EnableCustomRanks = false
-- Values: true, false

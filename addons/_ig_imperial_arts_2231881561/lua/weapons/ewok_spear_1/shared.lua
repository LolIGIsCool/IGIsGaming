...
SWEP.Slot = 0
SWEP.PrintName = "Ewok's spear (v1)"
SWEP.Author = "Tkaro"
SWEP.Spawnable = true
...
SWEP.DmgMin2 = 20
SWEP.DmgMax2 = 70
SWEP.ThrowModel = "models/tkaro/starwars/ewokspear/ewoks_spear_a.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["spear"] = { type = "Model", model = "models/tkaro/starwars/ewokspear/ewoks_spear_a.mdl", bone = "v_me_sledge", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1.014, 1.014, 0.755), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["spear"] = { type = "Model", model = "models/tkaro/starwars/ewokspear/ewoks_spear_a.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0, 1.5, 0), angle = Angle(-101.689, 0, 0), size = Vector(1.08, 1.08, 0.82), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
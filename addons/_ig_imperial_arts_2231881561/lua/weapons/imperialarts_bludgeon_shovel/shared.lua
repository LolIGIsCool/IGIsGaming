...
SWEP.Purpose = "Bury your enemies"
...
SWEP.WepName="imperialarts_bludgeon_shovel"
...
SWEP.VElements = {
	["hammer"] = { type = "Model", model = "models/models/danguyen/shovel.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.25, 0.5, 0), angle = Angle(0, -110, -5), size = Vector(0.82, 0.82, 0.82), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["hammer"] = { type = "Model", model = "models/models/danguyen/shovel.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 1.2, 0), angle = Angle(0, 90, 180), size = Vector(0.95, 0.95, 0.95), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

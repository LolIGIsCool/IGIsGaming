...
SWEP.WElements = {
	...
	["laser"] = { type = "Model", model = "models/sw_battlefront/weapons/2019/a280cfe_laser.mdl", bone = "", rel = "sl", pos = Vector(15.50, 1.45, 8.6), angle = Angle(0, 0, 270), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
	["laser_beam"] = { type = "Model", model = "models/cs574/weapons/atts/laser_beam.mdl", bone = "", rel = "sl", pos = Vector(28.50, -1.125, 9.35), angle = Angle(0, -90, 30), size = Vector(1.5, 1.5, 1.5), color = Color(0, 0, 0, 0), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true},

	["laser_beam_pointing"] = { type = "Model", model = "models/cs574/weapons/atts/laser_beam.mdl", bone = "", rel = "sl", pos = Vector(28.50, -1.125, 9.35), angle = Angle(0, -90, 90), size = Vector(1.5, 1.5, 1.5), color = Color(255, 20, 30, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false},
	["laser_beam_tracking"] = { type = "Model", model = "models/cs574/weapons/atts/laser_beam.mdl", bone = "", rel = "sl", pos = Vector(28.50, -1.125, 9.35), angle = Angle(0, -90, 90), size = Vector(1.5, 1.5, 1.5), color = Color(100, 255, 30, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false},
	["laser_beam_control"] = { type = "Model", model = "models/cs574/weapons/atts/laser_beam.mdl", bone = "", rel = "sl", pos = Vector(28.50, -1.125, 9.35), angle = Angle(0, -90, 90), size = Vector(1.5, 1.5, 1.5), color = Color(0, 100, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false},
}
...
SWEP.Attachments = {
	[1] = {
		header = "Modes",
		atts = {"rocket_mod_pointing","rocket_mod_tracking"}
	},
}
...
function SWEP:ShootBullet(...)
    if self.Owner:GetAmmoCount("RPG_Round") > 5 then
        self.Owner:SetAmmo(5, "RPG_Round")      
    end

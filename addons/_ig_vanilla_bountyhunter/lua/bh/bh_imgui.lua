...
imgui.skin = {
	...
	foregroundPress = Color(20,20,200,255),
}
...
local target = Material("materials/vanilla/skillicon/profitmythic.png");
...
function imgui.xCursor(x, y, w, h)
	...
	surface.DrawTexturedRectRotated(mx, my, h * 0.1, h * 0.1,-( CurTime() * 25 ) % 360);
end

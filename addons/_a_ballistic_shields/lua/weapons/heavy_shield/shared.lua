...
function SWEP:DrawHUD()
	...
	if(!IsValid(tr.Entity) || !(tr.Entity:GetClass() == "func_door")) then
...
function SWEP:Deploy()
	...
	if SERVER then
		...
		if owner:GetModel("models/player/ven/tk_major_01/tk_major.mdl") then
			holdtype = {4,"forward"}
		end
...
if SERVER then
		...
		timer.Simple(3.4, function()
			...
			ent:EmitSound( "ambient/explosions/explode_1.wav", 200 )

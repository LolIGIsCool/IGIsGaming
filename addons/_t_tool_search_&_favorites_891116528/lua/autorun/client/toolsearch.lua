...
hook.Add("PostReloadToolsMenu", "ToolSearch", function()
	if WireLib and GetConVar("wire_tool_menu_custom_menu_for_all_tabs"):GetBool() then
		print("Looks like you turned on the Wiremod's custom tool menu for all tabs. Not using Tool Search!")
		return
	end
	...
	spawnmenu.AddToolMenuOption("Utilities",
		...
		function(pnl)
			...
			pnl:AddControl("ListBox", {
				Options = {
					["#favorite_style_1"] = { cl_toolsearch_favoritestyle = 1 },
					["#favorite_style_2"] = { cl_toolsearch_favoritestyle = 2 },
					["#favorite_style_3"] = { cl_toolsearch_favoritestyle = 3 },
					["#favorite_style_4"] = { cl_toolsearch_favoritestyle = 4 },
				},

...
SWEP.VElements = {
	["fwmb"] = { type = "Model", model = "models/sw_battlefront/weapons/void/fwmb_10k.mdl", bone = "v_t21_reference001", rel = "", pos = Vector(0.5, 0, 1.25), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["fwmb"] = { type = "Model", model = "models/sw_battlefront/weapons/void/fwmb_10k.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5, 0.5, -3), angle = Angle(-8, 0, 172), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

...
SWEP.PrintName						= "SE-44"
SWEP.Type							= "First Order Blaster Pistol"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.VElements = {
	["se44"] = { type = "Model", model = "models/markus/fo_se44_blaster_pistol/fo_se44_blaster_pistol.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["se44"] = { type = "Model", model = "models/markus/fo_se44_blaster_pistol/fo_se44_blaster_pistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.5, 1.5, -1.7), angle = Angle(0, -90, 173), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

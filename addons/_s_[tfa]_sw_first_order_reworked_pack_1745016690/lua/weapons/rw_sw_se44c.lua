...
SWEP.PrintName						= "SE-44c"
SWEP.Type							= "First Order Automatic Blaster Pistol"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.VMPos = Vector(1.96, -4.814, -0.52)
...
SWEP.IronSightsPos = Vector(-5.92, -7, 1.55)
...
SWEP.VElements = {
	["se44"] = { type = "Model", model = "models/markus/fo_se44_blaster_pistol/fo_se44_blaster_pistol_white.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["se44"] = { type = "Model", model = "models/markus/fo_se44_blaster_pistol/fo_se44_blaster_pistol_white.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.5, 1.5, -1.7), angle = Angle(-5.5, 0, 173), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

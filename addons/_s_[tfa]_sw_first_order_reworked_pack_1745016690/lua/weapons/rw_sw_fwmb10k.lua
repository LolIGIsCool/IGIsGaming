...
SWEP.Manufacturer 					= "Corporation Sonn-Blas"
...
SWEP.Primary.IronAccuracy 			= 0.09
SWEP.Primary.SpreadMultiplierMax 	= 0.8
...
SWEP.IronSightsPos = Vector(-6.9, -3, 3.53)
...
SWEP.VElements = {
	["fwmb"] = { type = "Model", model = "models/sw_battlefront/weapons/fwmb10k_repeater_ext.mdl", bone = "v_t21_reference001", rel = "", pos = Vector(0.5, 0, 1.25), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0]=1,[1]=1,[2]=0,[3]=1,[4]=1,[5]=1,[6]=1,[7]=1,[8]=1} },
	["scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_t21_reference001", rel = "fwmb", pos = Vector(-03, 01, 6.25), angle = Angle(0, 90, 0), size = Vector(0.33, 0.33, 0.33), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}	

SWEP.WElements = {
	["fwmb"] = { type = "Model", model = "models/sw_battlefront/weapons/fwmb10k_repeater_ext.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5, 0.5, -1.5), angle = Angle(0, -90, 168), size = Vector(0.9, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0]=1,[1]=1,[2]=0,[3]=1,[4]=1,[5]=1,[6]=1,[7]=1,[8]=1} }
}

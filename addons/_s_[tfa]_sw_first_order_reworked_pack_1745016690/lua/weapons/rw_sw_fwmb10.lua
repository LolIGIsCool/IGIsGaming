...
SWEP.VMPos = Vector(2, -7, -2.6)
SWEP.VMAng = Vector(01.25, 0, 0)
...
SWEP.IronSightsPos = Vector(-3.91, -4, 3.65)
...
SWEP.VElements = {
	["fwmb"] = { type = "Model", model = "models/sw_battlefront/weapons/fwmb_10k.mdl", bone = "v_t21_reference001", rel = "", pos = Vector(0.5, 0, 1.25), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["visor"] = { type = "Model", model = "models/XQM/panel360.mdl", bone = "v_t21_reference001", rel = "fwmb", pos = Vector(3.2, 2.9, 5.85), angle = Angle(-28, 0, 180), size = Vector(0.034, 0.034, 0.034), color = Color(100, 100, 255, 255), surpresslightning = true, material = "models/screenspace", skin = 0, bodygroup = {} },
}	

...
ENT.PrintName = "TIE/IN Interceptor Royal Guard"
...
ENT.EntModel = "models/KingPommes/starwars/tie/interceptorR.mdl"
ENT.Vehicle = "IMP_TIE_InterceptorR"
...
if SERVER then
	...
	function ENT:SpawnFunction(pl, tr)
		local e = ents.Create("tie_in_interceptor_r")
...
if CLIENT then
	...
	function IMP_TIEInterceptorROfDoomReticle()
		local p = LocalPlayer()
		local Flying = p:GetNWBool("FlyingIMP_TIE_InterceptorR")
		local self = p:GetNWEntity("IMP_TIE_InterceptorR")
	...
	hook.Add("HUDPaint", "IMP_TIE_InterceptorRReticle", IMP_TIEInterceptorROfDoomReticle)

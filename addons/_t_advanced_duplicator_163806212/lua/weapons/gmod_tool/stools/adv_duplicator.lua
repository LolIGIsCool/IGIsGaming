...
function TOOL:ClearClipBoard()
	...
	self:GetOwner():ConCommand( "adv_duplicator_pastefrozen 1")
	self:GetOwner():ConCommand( "adv_duplicator_pastewoconst 1")
	...
	function AdvDuplicator_UpdateControlPanel()
		...
		if menu == "main" or not menu or menu == "" then
			...
			if AdvDupeClient.FileLoaded or AdvDupeClient.Copied then
				...
				bottom:CheckBox("Paste Frozen (Untick only if Needed):", "adv_duplicator_pastefrozen")
				bottom:CheckBox("Paste w/o Constraints (Do not untick):", "adv_duplicator_pastewoconst")
			end

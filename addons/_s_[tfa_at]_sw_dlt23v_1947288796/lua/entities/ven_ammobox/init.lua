...
util.AddNetworkString("ven_net_ammobox_cl_gui")
util.AddNetworkString("ven_net_ammobox_sv_createshell")
util.AddNetworkString("ven_net_ammobox_sv_createammo")
util.AddNetworkString("ven_net_ammobox_sv_close")

net.Receive("ven_net_ammobox_sv_createammo",function()
...
net.Receive("ven_net_ammobox_sv_createshell",function()
	local self = net.ReadEntity()
	local ply = net.ReadEntity()
	gred.CreateShell(self:GetPos() + Vector(0,0,70), self:GetAngles(), ply, {self}, net.ReadInt(10), net.ReadString(), 500, 2):Use(ply,ply,2,1)
end)

net.Receive("ven_net_ammobox_sv_close",function()
	local self = net.ReadEntity()
...
function ENT:Use(ply,cal)
	...
	net.Start("ven_net_ammobox_cl_gui")

...
function ENT:Draw()
	...
	cam.Start3D2D(self:GetPos() + Vector(0,0,70), ang,0.15)
		...
		local dX, _ = surface.GetTextSize("Blackmarket")

		surface.SetDrawColor(32,32,32,125)
		surface.DrawRect(-(dX + 32) / 2,-24,dX + 32,-40)
		draw.SimpleTextOutlined("Blackmarket","DermaLarge",0,-60,Color(235,235,235),TEXT_ALIGN_CENTER,TEXT_ALIGN_TOP,2,Color(25,25,25))
	cam.End3D2D()
end
...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/krieg/galacticempire/police/officer_anh/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
	-- ====== Health ====== --
...
function ENT:CustomOnInitialize() --[[Imperial Officer (ANH) Bodygroups]]--
	if math.random(1,0) == 1 then
		...
		self:SetBodygroup(2,math.random(1,2)) -- Code Cylinder 1
		...
		self:SetBodygroup(6,math.random(1,2)) -- Rank Square 1

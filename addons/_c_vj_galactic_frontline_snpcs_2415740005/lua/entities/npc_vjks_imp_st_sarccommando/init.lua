...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/krieg/galacticempire/stormtroopers/sarccommando/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
	-- ====== Health ====== --
ENT.StartHealth = 350 -- The starting health of the NPC
...
function ENT:CustomOnInitialize() --[[StormTrooper Bodygroups]]--
	if math.random(1,0) == 1 then
		...
		self:SetBodygroup(4,math.random(1,1)) -- Kit

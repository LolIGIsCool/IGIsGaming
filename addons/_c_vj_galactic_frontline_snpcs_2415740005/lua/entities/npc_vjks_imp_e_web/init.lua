...
function ENT:CustomOnInitialize()
	...
	self.ExtraGunModel:SetModel("models/krieg/galacticempire/weapons/e_web_turret.mdl")
	...
	self.ExtraGunModel2:SetModel("models/krieg/galacticempire/weapons/e_web_turret.mdl")

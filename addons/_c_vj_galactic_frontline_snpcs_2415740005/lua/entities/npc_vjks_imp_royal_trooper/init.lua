...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/krieg/galacticempire/royal/stormtrooper/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
	-- ====== Health ====== --
...
function ENT:CustomOnInitialize() --[[StormTrooper Bodygroups]]--
	if math.random(1,0) == 1 then
		...
		self:SetBodygroup(1,math.random(2,2)) -- Headwear
		...
		self:SetBodygroup(5,math.random(2,2)) -- Pouch

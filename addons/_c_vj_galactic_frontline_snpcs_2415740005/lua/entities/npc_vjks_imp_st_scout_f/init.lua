...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/krieg/galacticempire/stormtroopers/scout/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
	-- ====== Health ====== --
ENT.StartHealth = 45 -- The starting health of the NPC
...
ENT.SoundTbl_Pain = {"krieg/voice/sith/trooper/pain/1.wav",
					...
					"krieg/voice/sith/trooper/suppressed/1.wav",
					"krieg/voice/sith/trooper/suppressed/2.wav",
					"krieg/voice/sith/trooper/suppressed/3.wav",
					"krieg/voice/sith/trooper/suppressed/4.wav",
					"krieg/voice/sith/trooper/suppressed/5.wav",
					"krieg/voice/sith/trooper/suppressed/6.wav",
					"krieg/voice/sith/trooper/suppressed/7.wav",
					"krieg/voice/sith/trooper/suppressed/8.wav",
					"krieg/voice/sith/trooper/suppressed/9.wav",
					"krieg/voice/sith/trooper/suppressed/10.wav",
					"krieg/voice/sith/trooper/suppressed/11.wav"}
...
function ENT:CustomOnInitialize() --[[StormTrooper Bodygroups]]--
	if math.random(1,0) == 1 then
		...
		self:SetBodygroup(2,math.random(0,0)) -- Pauldron
		self:SetBodygroup(3,math.random(0,0)) -- Uniform
		self:SetBodygroup(4,math.random(0,0)) -- Kit
		self:SetBodygroup(5,math.random(0,0)) -- Pouch
		self:SetBodygroup(6,math.random(0,0)) -- Holster
		self:SetBodygroup(7,math.random(0,0)) -- Belt Boxes
	end
end
...
ENT.Secondaryweapon_class = "weapon_vjks_se14r"
ENT.Secondaryweapon_switchtime_primary = 0.4
ENT.Secondaryweapon_switchtime_secondary = 0.46
ENT.Secondaryweapon_originalclass = "weapon_vjks_se14r"

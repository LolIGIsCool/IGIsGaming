...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/krieg/galacticempire/stormtroopers/trooper/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
	-- ====== Health ====== --
...
function ENT:CustomOnInitialize() --[[StormTrooper Bodygroups]]--
	if math.random(1,0) == 1 then
		...
		self:SetBodygroup(1,math.random(0,1)) -- Headwear
		self:SetBodygroup(2,math.random(0,1)) -- Pauldron
		self:SetBodygroup(3,math.random(0,0)) -- Uniform
		self:SetBodygroup(4,math.random(0,4)) -- Kit
		self:SetBodygroup(5,math.random(0,2)) -- Pouch
...
ENT.Secondaryweapon_class = "weapon_vjks_e11"
...
ENT.Secondaryweapon_originalclass = "weapon_vjks_e11"

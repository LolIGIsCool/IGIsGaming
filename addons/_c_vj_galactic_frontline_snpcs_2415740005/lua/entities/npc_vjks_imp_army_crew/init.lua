...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/krieg/galacticempire/army/trooper_jumpsuit/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
	-- ====== Health ====== --
...
function ENT:CustomOnInitialize() --[[Imperial Army Crew Bodygroups]]--
	if math.random(1,0) == 1 then
		self:SetSkin(math.random(0,3)) -- Rank
		self:SetBodygroup(0,math.random(0,4)) -- Heads
		self:SetBodygroup(1,math.random(1,3)) -- Headwear
		self:SetBodygroup(2,math.random(2,2)) -- Uniform
		self:SetBodygroup(3,math.random(0,6)) -- Belt Boxes
		self:SetBodygroup(4,math.random(2,2)) -- Webbings

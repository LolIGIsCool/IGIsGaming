...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/KriegSyntax/rebel/navy/fleet_trooper/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = ("80")
...
ENT.SoundTbl_Breath = {}
ENT.SoundTbl_Idle = {"kstrudel/rebels/rebel2/escaping2.wav",
					"kstrudel/rebels/rebel2/escaping1.wav",
					"kstrudel/rebels/rebel2/escaping3.wav",
					"kstrudel/rebels/rebel2/giveup1.wav",
					"kstrudel/rebels/rebel2/giveup2.wav",
					"kstrudel/rebels/rebel2/giveup3.wav",
					"kstrudel/rebels/rebel2/confuse3.wav",
					"kstrudel/rebels/rebel2/giveup4.wav",
...
function ENT:CustomOnInitialize()
	if math.random(1,0) == 1 then
		self:SetBodygroup(0,math.random(0,0)) -- Headwear
		self:SetBodygroup(2,math.random(0,18)) -- Heads
		self:SetBodygroup(3,math.random(0,0)) -- Vest
		self:SetBodygroup(4,math.random(0,11)) -- Ranks
		self:SetBodygroup(5,math.random(0,2)) -- Pants
	end
end

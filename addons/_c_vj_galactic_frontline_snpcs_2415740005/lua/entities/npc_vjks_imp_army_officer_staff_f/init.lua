...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/krieg/galacticempire/army/officer_anh/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
	-- ====== Health ====== --
...
function ENT:CustomOnInitialize() --[[Imperial Officer (ANH) Bodygroups]]--
	if math.random(1,0) == 1 then
		...
		self:SetBodygroup(8,math.random(0,1)) -- Rank Square 3
		self:SetBodygroup(9,math.random(0,0)) -- Rank Square 4

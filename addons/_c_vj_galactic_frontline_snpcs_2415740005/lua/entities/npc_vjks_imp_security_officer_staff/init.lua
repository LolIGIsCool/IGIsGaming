...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/krieg/galacticempire/security/officer_anh/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
	-- ====== Health ====== --
...
function ENT:CustomOnInitialize() --[[Imperial Officer (ANH) Bodygroups]]--
	if math.random(1,0) == 1 then
		self:SetBodygroup(0,math.random(0,5)) -- Heads
		self:SetBodygroup(1,math.random(0,0)) -- Headwear
		self:SetBodygroup(2,math.random(0,2)) -- Code Cylinder 1
		self:SetBodygroup(3,math.random(0,2)) -- Code Cylinder 2
		self:SetBodygroup(4,math.random(0,2)) -- Code Cylinder 3
		self:SetBodygroup(5,math.random(0,2)) -- Code Cylinder 4
		self:SetBodygroup(6,math.random(0,2)) -- Rank Square 1
		self:SetBodygroup(7,math.random(1,1)) -- Rank Square 2
		self:SetBodygroup(8,math.random(1,1)) -- Rank Square 3
		self:SetBodygroup(9,math.random(0,1)) -- Rank Square 4
		self:SetBodygroup(10,math.random(0,0)) -- Rank Square 5
		self:SetBodygroup(11,math.random(0,0)) -- Rank Square 6
		self:SetBodygroup(12,math.random(0,0)) -- Uniform
		self:SetBodygroup(13,math.random(0,6)) -- Belt Boxes
		self:SetBodygroup(14,math.random(0,3)) -- Holster
	end
end

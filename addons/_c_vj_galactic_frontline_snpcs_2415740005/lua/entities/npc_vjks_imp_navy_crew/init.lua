...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/krieg/galacticempire/navy/crew/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
	-- ====== Health ====== --
...
ENT.AnimTbl_IdleStand = {"KScrewidle01","KScrewidle02","KScrewidle03"}
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------ AI / Sound Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
function ENT:CustomOnInitialize() --[[Imperial Army Crew Bodygroups]]--
	if math.random(1,0) == 1 then
		self:SetSkin(math.random(0,2)) -- Rank
		...
		self:SetBodygroup(6,math.random(0,0)) -- Mask
	end
end

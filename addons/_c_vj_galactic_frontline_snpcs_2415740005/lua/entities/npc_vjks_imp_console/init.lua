...
-----------------------------------------------*/
ENT.Model = {"models/krieg/galacticempire/props/imp_console_1.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 4000
ENT.HullType = HULL_HUMAN
ENT.SightDistance = 0.1 -- How far it can see
...
ENT.Crew_GunnerPosition = Vector(60.4,-2,15)
ENT.Crew_FoundEnt = NULL
ENT.Crew_GunnerAnim = "KScrewuse01"
ENT.Crew_GunnerAnim2 = "KScrewuse01"
...
function ENT:CustomOnInitialize()
	...
	self.ExtraGunModel:SetModel("models/KriegSyntax/weapons/e_web/e_web_turret.mdl")
	self.ExtraGunModel:SetLocalPos( self:LocalToWorld( Vector(0,0,42) ) )
	self.ExtraGunModel:SetLocalAngles(Angle(self:GetAngles().p,self:GetAngles().y-180,self:GetAngles().r))
	...
	self.ExtraGunModel2:SetModel("models/KriegSyntax/weapons/e_web/e_web_turret.mdl")
	self.ExtraGunModel2:SetLocalPos(self:LocalToWorld( Vector(-12,0,39) ) )
															--FB  --LR --H
	self.ExtraGunModel2:SetLocalAngles(Angle(self:GetAngles().p,self:GetAngles().y-180,self:GetAngles().r))

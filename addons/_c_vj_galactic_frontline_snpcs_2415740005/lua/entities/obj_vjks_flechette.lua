...
ENT.Model = {"models/props_phx2/garbage_metalcan001a.mdl"} -- The models it should spawn with | Picks a random one from the table
...
ENT.RadiusDamage = 2 -- How much damage should it deal? Remember this is a radius damage, therefore it will do less damage the farther away the entity is from its enemy
ENT.RadiusDamageUseRealisticRadius = true -- Should the damage decrease the farther away the enemy is from the position that the projectile hit?
ENT.RadiusDamageType = DMG_CUT -- Damage type

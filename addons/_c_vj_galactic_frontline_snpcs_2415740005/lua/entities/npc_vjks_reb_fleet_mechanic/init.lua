...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/KriegSyntax/rebel/navy/engineer_crew_gunner/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
	-- ====== Health ====== --
...
function ENT:CustomOnInitialize()
	if math.random(1,0) == 1 then
		...
		self:SetBodygroup(9,math.random(0,0))
	end
end	

...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/krieg/galacticempire/army/engineer/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
	-- ====== Health ====== --
...
function ENT:CustomOnInitialize() --[[Army Engineer Bodygroups]]--
	if math.random(1,0) == 1 then
		self:SetBodygroup(0,math.random(0,5)) -- Heads
		self:SetBodygroup(1,math.random(0,0)) -- Headwear
		self:SetBodygroup(2,math.random(0,1)) -- Uniform
		self:SetBodygroup(3,math.random(0,6)) -- Belt Boxes
		self:SetBodygroup(4,math.random(0,3)) -- Webbings
		self:SetBodygroup(5,math.random(0,0)) -- Holster
	end
end

...
if CLIENT then
	...
	local LangName = "obj_vjks_detonator"
...
function ENT:CustomOnInitialize()
    ...
    self.grenadeprop:SetModel("models/kriegsyntax/weapons/detonator_thermal/detonator_thermal.mdl")

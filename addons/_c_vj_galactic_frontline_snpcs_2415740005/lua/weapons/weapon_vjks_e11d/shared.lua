...
SWEP.Purpose					= "The Standard blaster carbine for the assault troops of the Empire"
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	-- ====== Primary Data ====== --
SWEP.MadeForNPCsOnly = true
SWEP.WorldModel					= "models/krieg/galacticempire/weapons/blastech_e11d.mdl" -- The world model (Third person, when a NPC is holding it, on ground, etc.)
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
SWEP.Primary.Sound				= {"weapons/e11d/e11d_1.ogg",
									"weapons/e11d/e11d_2.ogg",
									"weapons/e11d/e11d_3.ogg"}
...
SWEP.NPC_RangeMediumBurst2 = 3
SWEP.NPC_RangeMediumCooldown1 = 0.5
SWEP.NPC_RangeMediumCooldown2 = 1.4
SWEP.NPC_RangeFarDist = 3100
SWEP.NPC_RangeFarBurst1 = 3
SWEP.NPC_RangeFarBurst2 = 3
SWEP.NPC_RangeFarCooldown1 = 0.4
SWEP.NPC_RangeFarCooldown2 = 1.8
SWEP.NPC_RangeVeryFarBurst1 = 3
SWEP.NPC_RangeVeryFarBurst2 = 3
SWEP.NPC_RangeVeryFarCooldown1 = 0.8

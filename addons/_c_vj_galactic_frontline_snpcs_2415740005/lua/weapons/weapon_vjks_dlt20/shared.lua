...
SWEP.WorldModel					= "models/krieg/galacticempire/weapons/blastech_dlt20.mdl" 
SWEP.WorldModel					= "models/krieg/galacticempire/weapons/blastech_dlt20.mdl" -- The world model (Third person, when a NPC is holding it, on ground, etc.)
...
SWEP.Primary.ClipSizeReload		= 0 -- If there is x amount of bullets left in the clip, then reload
...
SWEP.Primary.TracerType			= "ks_effect_sw_laser_green" -- Tracer type (Examples: AR2, laster, 9mm)
SWEP.Primary.TakeAmmo			= 1 -- How much ammo should it take on each shot?
SWEP.Primary.Automatic			= true -- Is it automatic?
SWEP.Primary.Ammo				= "AR2" -- Ammo type
SWEP.Primary.Sound				= "weapons/dlt20a/dlt20a_fire.ogg"
SWEP.Primary.HasDistantSound	= true -- Does it have a distant sound when the gun is shot?
SWEP.Primary.DistantSound		= "weapons/dlt20a/dlt20a_fire.ogg"
SWEP.Primary.DistantSoundVolume	= 100 -- Distant sound volume

...
function SWEP:SetupWeaponHoldTypeForAI(hType)
	...
	if rifleOverride == true or hType == "ar2" or hType == "smg" then
		...
		self.ActivityTranslateAI[ACT_IDLE] 							= ACT_IDLE_SMG1_RELAXED
		self.ActivityTranslateAI[ACT_IDLE_ANGRY] 					= ACT_IDLE_SMG1_RELAXED
		self.ActivityTranslateAI[ACT_IDLE_RELAXED] 					= ACT_IDLE_SMG1_RELAXED
		self.ActivityTranslateAI[ACT_IDLE_STIMULATED] 				= ACT_IDLE_SMG1_RELAXED
		...
		self.ActivityTranslateAI[ACT_IDLE_AIM_STIMULATED] 			= ACT_IDLE_SMG1_RELAXED
		self.ActivityTranslateAI[ACT_IDLE_AIM_AGITATED] 			= ACT_IDLE_AIM_RIFLE_STIMULATED
		self.ActivityTranslateAI[ACT_WALK] 							= ACT_WALK_RIFLE_RELAXED

...
SWEP.WorldModel					= "models/krieg/galacticempire/weapons/blastech_se09e.mdl" 
SWEP.WorldModel					= "models/krieg/galacticempire/weapons/blastech_se09e.mdl" -- The world model (Third person, when a NPC is holding it, on ground, etc.)

...
SWEP.WorldModel					= "models/krieg/galacticempire/weapons/blastech_se14r.mdl" 
SWEP.WorldModel					= "models/krieg/galacticempire/weapons/blastech_se14r.mdl" -- The world model (Third person, when a NPC is holding it, on ground, etc.)

...
SWEP.PrintName					= "Imperial T21 Heavy Blaster Rifle"
SWEP.Author 					= "KStrudel"
SWEP.Purpose					= "A Heavy blaster for the footsoldiers of the Empire"
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	-- ====== Primary Data ====== --
SWEP.MadeForNPCsOnly = true
SWEP.WorldModel					= "models/krieg/galacticempire/weapons/blastech_t21.mdl" 
...
SWEP.NPC_SecondaryFireChance = 1.5 -- Chance that the secondary fire is used | 1 = always
SWEP.NPC_SecondaryFireDistance = 1500 -- How close does the owner's enemy have to be for it to fire?
SWEP.NPC_SecondaryFireNext = VJ_Set(1, 2) -- How much time until the secondary fire can be used again?
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
SWEP.Primary.Sound				= "weapons/t21/t21_fire.ogg"
SWEP.Primary.DistantSound		= "weapons/t21/t21_fire_distant.ogg"


SWEP.Primary.DistantSoundLevel = 120 -- Distant sound level
SWEP.Primary.DistantSoundVolume	= 10.25 -- Distant sound volume

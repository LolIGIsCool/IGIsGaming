...
SWEP.Purpose					= "The Standard blaster for the footsoldiers of the Empire"
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	-- ====== Primary Data ====== --
SWEP.MadeForNPCsOnly = true
SWEP.WorldModel					= "models/krieg/galacticempire/weapons/blastech_dlt19.mdl"  
...
SWEP.NPC_RangeCloseDist = 950
SWEP.NPC_RangeCloseBurst1 = 18
SWEP.NPC_RangeCloseBurst2 = 25
SWEP.NPC_RangeCloseCooldown1 = 0.1
SWEP.NPC_RangeCloseCooldown2 = 0.2
SWEP.NPC_RangeMediumDist = 1800
SWEP.NPC_RangeMediumBurst1 = 10
SWEP.NPC_RangeMediumBurst2 = 10
SWEP.NPC_RangeMediumCooldown1 = 0.5
SWEP.NPC_RangeMediumCooldown2 = 1.4
SWEP.NPC_RangeFarDist = 3100
SWEP.NPC_RangeFarBurst1 = 4
SWEP.NPC_RangeFarBurst2 = 22
SWEP.NPC_RangeFarCooldown1 = 0.4
SWEP.NPC_RangeFarCooldown2 = 1.1
SWEP.NPC_RangeVeryFarBurst1 = 5
SWEP.NPC_RangeVeryFarBurst2 = 12
SWEP.NPC_RangeVeryFarCooldown1 = 1.8

...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
SWEP.Base 						= "vjks_weapon_vj_base"
SWEP.PrintName					= "BlasTech E-22"
SWEP.Author 					= "KStrudel"
SWEP.Purpose					= "An elite blaster for the footsoldiers of the Empire"
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	-- ====== Primary Data ====== --
SWEP.MadeForNPCsOnly = true
SWEP.WorldModel					= "models/krieg/galacticempire/weapons/blastech_e22.mdl" 
...
SWEP.NPC_RangeCloseBurst1 = 0
SWEP.NPC_RangeCloseBurst2 = 2
SWEP.NPC_RangeCloseCooldown1 = 0.8
SWEP.NPC_RangeCloseCooldown2 = 1.2
SWEP.NPC_RangeMediumDist = 1800
SWEP.NPC_RangeMediumBurst1 = 0
SWEP.NPC_RangeMediumBurst2 = 2
SWEP.NPC_RangeMediumCooldown1 = 1.95
SWEP.NPC_RangeMediumCooldown2 = 2
SWEP.NPC_RangeFarDist = 3100
SWEP.NPC_RangeFarBurst1 = 0
SWEP.NPC_RangeFarBurst2 = 2
SWEP.NPC_RangeFarCooldown1 = 1.8
SWEP.NPC_RangeFarCooldown2 = 2.8
SWEP.NPC_RangeVeryFarBurst1 = 0
SWEP.NPC_RangeVeryFarBurst2 = 2
SWEP.NPC_RangeVeryFarCooldown1 = 1
SWEP.NPC_RangeVeryFarCooldown2 = 1.3
SWEP.NPC_RangeAdjustDecrease = 500

...
function ENT:VJ_TASK_COVER_FROM_ENEMY(moveType, customFunc)
	...
	vsched.RunCode_OnFail = function()
		...
		vschedFail:EngTask("TASK_SET_ROUTE_SEARCH_TIME", 0.5)
		vschedFail:EngTask("TASK_GET_PATH_TO_RANDOM_NODE", 1500)
...
local task_idleWander = ai_vj_schedule.New("vj_idle_wander")
	...
	task_idleWander:EngTask("TASK_GET_PATH_TO_RANDOM_NODE", math.Rand(833,3446))

...
SWEP.MuzzleEffect 				= "rw_npcsw_muzzleflash_green"
SWEP.EnableMuzzleEffect			= false
SWEP.ShellEffect				= ""
SWEP.EnableShellEffect			= false
SWEP.TracerEffect				= "rw_sw_laser_green"
SWEP.ReloadSounds				= {{0, "rw_swnpc_reload_heavy"}}
SWEP.ImpactDecal 				= "FadingScorch"
SWEP.ExtraShootEffects			= {
	{ EffectName = "rw_sw_impact_green", Scale = 1, Magnitude = 1, Radius = 1 },
}
...
SWEP.Primary.Sound				= "rw_swnpc_dlt20a"

SWEP.ClientModel				= {
	model						= "models/kuro/sw_battlefront/weapons/bf1/dlt20a.mdl",
	pos							= Vector(4, 01, 02),

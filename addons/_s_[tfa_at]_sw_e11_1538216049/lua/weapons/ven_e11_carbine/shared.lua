...
SWEP.Primary.Sound 					= Sound ("Weapon_E11_OG_light.Single");
...
SWEP.CrouchRecoilMultiplier			= 0.80
SWEP.JumpRecoilMultiplier			= 2.4
...
SWEP.ViewModel = "models/ven/sw_battlefront/weapons/bf2017/v_e11_long.mdl"
SWEP.WorldModel = "models/bf2017/ven/w_e11_long.mdl"
...
SWEP.BlowbackVector 				= Vector(0,-.8,0)
...
SWEP.Primary.KickDown				= 0.078
SWEP.Primary.KickHorizontal			= 0.058
...
SWEP.Primary.SpreadIncrement 		= 0.37
SWEP.Primary.SpreadRecovery 		= 0.93
SWEP.DisableChambering 				= true
SWEP.MoveSpeed 						= 1

...
function PermaProps.ReloadPermaProps()
	print("[PERMAPROPS] Starting spawning")
	local startspawntime = SysTime()
	...
	print("[PERMAPROPS] Spawning Finished Time Taken:"..SysTime()-startspawntime)
end
...
function PermaProps.IsAdmin( ply )
	...
	if ( PermaProps.IsUserGroup(ply, "lead event master") or false ) then return true end
    return false

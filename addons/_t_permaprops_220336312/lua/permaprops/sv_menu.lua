...
local function PermissionLoad()
	...
	PermaProps.Permissions["advisor"] = { Physgun = true, Tool = true, Property = true, Save = true, Delete = true, Update = true, Menu = true, Permissions = true, Inherits = "admin", Custom = true }
	...
	if CAMI then
		...
		for k, v in pairs(CAMI.GetUsergroups()) do
			...
			if k == "superadmin" or k == "advisor" or k == "admin" or k == "user" then continue end

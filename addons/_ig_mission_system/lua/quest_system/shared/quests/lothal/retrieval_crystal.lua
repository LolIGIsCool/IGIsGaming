QUEST.Name = "Crystal Chase"
QUEST.Instruction = "Lord Vader has misplaced some kyber crystals, go find them." -- %s will equal the amount
QUEST.Info = "Go find the kyber crystals around the ship."
...
QUEST.Item = {
    ["Name"] = "Kyber Crystal", -- name of the item
    ["Model"] = "models/cyan/cyan.mdl", -- model of the item

QUEST.Name = "Legless Droid"
QUEST.Instruction = "My droid lost his leg, find it for a reward." -- %s will equal the amount
QUEST.Info = "Go find my droid leg, it could be anywhere."
QUEST.Reward = 25 -- credit reward
...
QUEST.Penalty = 5 -- penalty reward

QUEST.Item = {
    ["Name"] = "Droid Part", -- name of the item
    ["Model"] = "models/kingpommes/starwars/misc/droids/leg_front.mdl", -- model of the item

QUEST.Name = "Throw a Flashbang"
QUEST.Instruction = "Utilize your flashbang to gain the upperhand." -- %s will equal the amount
QUEST.Info = "Throw 2 flashbangs, make sure you have a valid reason though."
...
if (SERVER) then
    hook.Add("throwflashbang", "flashbangquest", function(ply)
        if (ply:IsPlayer() and ply.QUEST_SYSTEM_ActiveQuest == "throw_flashbang") then

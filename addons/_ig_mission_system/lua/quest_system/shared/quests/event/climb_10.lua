QUEST.Name = "High Climber"
QUEST.Instruction = "Practice your skills with Climb Swep by climbing 10 times." -- %s will equal the amount
...
if (SERVER) then
    hook.Add("playerclimbjump", "registerjumpquest10", function(player, jumps)
        if (player:IsPlayer() and player.QUEST_SYSTEM_ActiveQuest == "climb_10") and jumps ~= 0 then

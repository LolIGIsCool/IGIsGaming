QUEST.Name = "Throw Thermal Detonator"
QUEST.Instruction = "Throw 2 thermal detonators, with a valid reason." -- %s will equal the amount
QUEST.Info = "Very Simple, find a valid reason to throw a thermal detonator twice."
QUEST.Reward = 10 -- credit reward
...
if (SERVER) then
    hook.Add("thermaldetquest", "throwthermaldetquest", function(ply)
        if (ply:IsPlayer() and ply.QUEST_SYSTEM_ActiveQuest == "throw_thermaldet") then

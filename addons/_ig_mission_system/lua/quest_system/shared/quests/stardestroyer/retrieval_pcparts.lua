QUEST.Name = "Computer Part Search"
QUEST.Instruction = "Retrieve my lost computer parts for a credit reward." -- %s will equal the amount
QUEST.Info = "Go around searching for parts."
...
QUEST.Item = {
    ["Name"] = "Computer Part", -- name of the item
    ["Model"] = "models/modgun/modgun.mdl", -- model of the item

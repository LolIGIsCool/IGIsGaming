QUEST.Name = "Bunk Inspection #1"
QUEST.Instruction = "Word has gotten out of a deathstick smuggling ring, go search troopers bunks for evidence" -- %s will equal the amount
QUEST.Info = "Go search trooper bunks for deathsticks."
...
QUEST.Item = {
    ["Name"] = "Deathsticks", -- name of the item
    ["Model"] = "models/cire992/props/glass01.mdl", -- model of the item

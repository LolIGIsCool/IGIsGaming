QUEST.Name = "Clumsy Stormtroopers"
QUEST.Instruction = "Some stormtroopers have misplaced their weapons, go find them." -- %s will equal the amount
QUEST.Info = "Go find the E-11s around the ship."
...
QUEST.Item = {
    ["Name"] = "E-11 Blaster Rifle", -- name of the item
    ["Model"] = "models/bf2017/w_e11.mdl", -- model of the item

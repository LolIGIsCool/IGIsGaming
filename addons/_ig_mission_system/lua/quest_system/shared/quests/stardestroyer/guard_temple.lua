QUEST.Name = "Emperors Shield"
QUEST.Instruction = "Guard the sith temple for 10 minutes." -- %s will equal the amount
...
if (SERVER) then
    timer.Create("isguardingsith", 1, 0, function()
        for k, v in pairs(ents.FindInSphere(Vector( -11105.85, 12622.43, 13312.03 ), 300)) do
            if (v:IsPlayer() and v.QUEST_SYSTEM_ActiveQuest == "guard_temple") then

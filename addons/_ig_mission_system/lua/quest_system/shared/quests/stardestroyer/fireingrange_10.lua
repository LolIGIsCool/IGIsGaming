QUEST.Name = "Battle Ready"
QUEST.Instruction = "Head over to the fireing range and hit 10 bullseyes" -- %s will equal the amount
QUEST.Info = "The firing range can be found in the recruit room, hit 10 bullseyes"
...
if (SERVER) then
    hook.Add("EntityTakeDamage", "fireingrange10quest", function(ent, dmginfo)
        ...
        if (targetname == "shoot1Trgt" or targetname == "shoot2Trgt" or targetname == "shoot3Trgt" or targetname == "shoot4Trgt") then
            if (ply:IsPlayer() and ply.QUEST_SYSTEM_ActiveQuest == "fireingrange_10") then

QUEST.Name = "Busted Batteries"
QUEST.Instruction = "A shipment of batteries broke open, go around collecting some" -- %s will equal the amount
QUEST.Info = "Go around finding the batteries."
QUEST.Reward = 600 -- credit reward
QUEST.Time = 360 -- how long, in seconds, a player has to complete the quest. 0 = infinite
QUEST.Amount = 6 -- how many actions required to complete quest
QUEST.Penalty = 60 -- penalty reward

QUEST.Item = {
    ["Name"] = "Battery", -- name of the item
    ["Model"] = "models/batt/batt.mdl", -- model of the item

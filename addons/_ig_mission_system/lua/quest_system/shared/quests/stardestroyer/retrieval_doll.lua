QUEST.Name = "Curious Stormtroopers"
QUEST.Instruction = "Go find and confiscate play dolls from around the ship." -- %s will equal the amount
QUEST.Info = "Go around finding the Dolls around the ship."
QUEST.Reward = 600 -- credit reward
QUEST.Time = 360 -- how long, in seconds, a player has to complete the quest. 0 = infinite
QUEST.Amount = 5 -- how many actions required to complete quest
QUEST.Penalty = 60 -- penalty reward

QUEST.Item = {
    ["Name"] = "Trooper Doll", -- name of the item
    ["Model"] = "models/kingpommes/starwars/misc/st_doll.mdl", -- model of the item

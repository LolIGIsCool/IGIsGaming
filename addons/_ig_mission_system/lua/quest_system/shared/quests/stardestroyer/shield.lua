QUEST.Name = "Selfless Protector"
QUEST.Instruction = "Place your shield down for the protection of yourself or others." -- %s will equal the amount
QUEST.Info = "Its simple, place your shield twice."
...
if (SERVER) then
    hook.Add("placedownshield", "shielddownquest", function(ply)
        if (ply:IsPlayer() and ply.QUEST_SYSTEM_ActiveQuest == "shield") then

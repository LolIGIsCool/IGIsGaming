QUEST.Name = "Efficient Security Officer"
QUEST.Instruction = "Handcuff 3 players who are breaking the law." -- %s will equal the amount
QUEST.Info = "Handcuff 3 players who are breaking the law, not very hard."
...
if (SERVER) then
    hook.Add("OnHandcuffed", "cuffquest", function(ply)
        if (ply:IsPlayer() and ply.QUEST_SYSTEM_ActiveQuest == "cuff_3") then

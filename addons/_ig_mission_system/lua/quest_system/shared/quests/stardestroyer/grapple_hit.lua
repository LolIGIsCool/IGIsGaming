QUEST.Name = "High Flyer"
QUEST.Instruction = "Utilize your grapple hook." -- %s will equal the amount
QUEST.Info = "Use your grapple hook 5 times."
...
if (SERVER) then
    hook.Add("grapplelaunch", "grapplehitquest", function(ply)
        if (ply:IsPlayer() and ply.QUEST_SYSTEM_ActiveQuest == "grapple_hit") then

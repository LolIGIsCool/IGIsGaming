...
INFO: Used to load autorun file for Military SNPCs - Nazi Germany
--------------------------------------------------*/
-- Addon Information(Important!):
	local PublicAddonName = "Dinosaurs"
	local AddonName = "Dinosaurs"
...
if( file.Exists( VJExists, "GAME" ) ) then
	...
	AddCSLuaFile("autorun/vj_dino_autorun.lua")
	AddCSLuaFile("autorun/vj_dino_convar.lua")
	AddCSLuaFile("autorun/vj_dino_spawn.lua")

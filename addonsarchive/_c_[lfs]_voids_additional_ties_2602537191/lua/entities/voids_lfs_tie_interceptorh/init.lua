...
util.PrecacheModel( "models/void/starwars/tie/interceptor_hyper.mdl" )
if (!util.IsValidModel( "models/void/starwars/tie/interceptor_hyper.mdl" )) then return end
...
function ENT:PrimaryAttack()
	...
	local fP = { Vector(225.99,127.58,31.98),Vector(225.99,-127.58,31.98),Vector(225.99,-127.58,-31.98),Vector(225.99,127.58,-31.98) } --  -y,x,z

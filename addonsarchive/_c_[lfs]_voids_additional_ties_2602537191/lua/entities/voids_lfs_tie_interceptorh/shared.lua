...
ENT.PrintName = "TIE-Interceptor Hyperdrive"
ENT.Author = "Void"
ENT.Information = "Default TIE Interceptor equiped with a Class 2 Hyperdrive"
ENT.Category = "[LFS] Empire" -- "[LFS] Void"

ENT.Spawnable		= true
ENT.AdminSpawnable		= false

ENT.MDL = "models/void/starwars/tie/interceptor_hyper.mdl"

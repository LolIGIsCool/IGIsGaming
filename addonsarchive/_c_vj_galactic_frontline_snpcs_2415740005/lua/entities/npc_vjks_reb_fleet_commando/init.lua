...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/KriegSyntax/rebel/navy/fleet_commando/npc_male_01.mdl","models/KriegSyntax/rebel/navy/fleet_commando2/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = ("120")
...
ENT.SoundTbl_Investigate = {"kstrudel/imps/commando_radio_1.ogg",
					"kstrudel/imps/commando_radio_2.ogg",
					"kstrudel/imps/commando_radio_3.ogg",
					"kstrudel/imps/commando_radio_4.ogg",
					"kstrudel/imps/commando_radio_5.ogg",
...
function ENT:CustomOnInitialize()
	if math.random(1,0) == 1 then
		...
		self:SetBodygroup(3,math.random(2,5))

...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/KriegSyntax/imperial/compnor/comp_isb_officer_esb/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = ("50")
...
ENT.AnimTbl_IdleStand = {"KSOfficeridle01"} -- The idle animation when AI is enabled
...
ENT.SoundTbl_FootStep = {"kstrudel/imps/boot1.wav","kstrudel/imps/boot2.wav",
						"kstrudel/imps/boot3.wav","kstrudel/imps/boot4.wav"}
ENT.SoundTbl_Breath = {}
ENT.SoundTbl_Idle = {"kstrudel/imps/impoff1/idle/idle_1.wav",
					"kstrudel/imps/impoff1/idle/idle_2.wav",
					"kstrudel/imps/impoff1/idle/idle_3.wav",
					"kstrudel/imps/impoff1/idle/idle_4.wav",
					"kstrudel/imps/impoff1/idle/idle_5.wav",
					"kstrudel/imps/impoff1/idle/idle_6.wav",
					"kstrudel/imps/impoff1/idle/idle_7.wav",
					"kstrudel/imps/impoff1/idle/idle_8.wav"}
ENT.SoundTbl_CombatIdle = {"kstrudel/imps/impoff1/combatidle/combatidle_1.wav",
						"kstrudel/imps/impoff1/combatidle/combatidle_2.wav",
						"kstrudel/imps/impoff1/combatidle/combatidle_3.wav"}
ENT.SoundTbl_OnReceiveOrder = {"kstrudel/imps/impoff1/onrecievingorder/onrecievingorder_1.wav",
							"kstrudel/imps/impoff1/onrecievingorder/onrecievingorder_2.wav",
							"kstrudel/imps/impoff1/onrecievingorder/onrecievingorder_3.wav",
							"kstrudel/imps/impoff1/onrecievingorder/onrecievingorder_4.wav",
							"kstrudel/imps/impoff1/onrecievingorder/onrecievingorder_5.wav",
							"kstrudel/imps/impoff1/onrecievingorder/onrecievingorder_6.wav",
							"kstrudel/imps/impoff1/onrecievingorder/onrecievingorder_7.wav",
							"kstrudel/imps/impoff1/onrecievingorder/onrecievingorder_8.wav"}
...
ENT.SoundTbl_OnPlayerSight = {"kstrudel/imps/impoff1/onplayersight/onplayersight_1.wav",
							"kstrudel/imps/impoff1/onplayersight/onplayersight_2.wav",
							"kstrudel/imps/impoff1/onplayersight/onplayersight_3.wav",
							"kstrudel/imps/impoff1/onplayersight/onplayersight_4.wav",
							"kstrudel/imps/impoff1/onplayersight/onplayersight_5.wav",
							"kstrudel/imps/impoff1/onplayersight/onplayersight_6.wav",
							"kstrudel/imps/impoff1/onplayersight/onplayersight_7.wav",
							"kstrudel/imps/impoff1/onplayersight/onplayersight_8.wav",
							"kstrudel/imps/impoff1/onplayersight/onplayersight_9.wav",
							"kstrudel/imps/impoff1/onplayersight/onplayersight_10.wav",
							"kstrudel/imps/impoff1/onplayersight/onplayersight_11.wav",
							"kstrudel/imps/impoff1/onplayersight/onplayersight_12.wav"}
ENT.SoundTbl_Investigate = {"kstrudel/imps/impoff1/idle/idle_6.wav",
							"kstrudel/imps/impoff1/idle/idle_8.wav",
							"kstrudel/imps/impoff1/idle/idle_5.wav",
							"kstrudel/imps/impoff1/idle/idle_4.wav",
							"kstrudel/imps/impoff1/idle/idle_7.wav"}
ENT.SoundTbl_Alert = {"kstrudel/imps/impoff1/alert/alert_1.wav",
					"kstrudel/imps/impoff1/alert/alert_2.wav",
					"kstrudel/imps/impoff1/alert/alert_3.wav",
					"kstrudel/imps/impoff1/alert/alert_4.wav",
					"kstrudel/imps/impoff1/alert/alert_5.wav",
					"kstrudel/imps/impoff1/alert/alert_6.wav",
					"kstrudel/imps/impoff1/alert/alert_7.wav",
					"kstrudel/imps/impoff1/alert/alert_8.wav",
					"kstrudel/imps/impoff1/alert/alert_9.wav",
					"kstrudel/imps/impoff1/alert/alert_10.wav"}
ENT.SoundTbl_CallForHelp = {"kstrudel/imps/impoff1/suppressing/suppressing_1.wav"}
ENT.SoundTbl_BecomeEnemyToPlayer = {"kstrudel/imps/impoff1/onplayersight/onplayersight_1.wav",
							"kstrudel/imps/impoff1/onplayersight/onplayersight_2.wav",
							"kstrudel/imps/impoff1/onplayersight/onplayersight_3.wav",
							"kstrudel/imps/impoff1/onplayersight/onplayersight_4.wav",
							"kstrudel/imps/impoff1/onplayersight/onplayersight_5.wav",
...
ENT.SoundTbl_GrenadeAttack = {"kstrudel/imps/impoff1/grenadeattack/grenadeattack_1.wav",
							"kstrudel/imps/impoff1/grenadeattack/grenadeattack_2.wav",
							"kstrudel/imps/impoff1/grenadeattack/grenadeattack_3.wav",
							"kstrudel/imps/impoff1/grenadeattack/grenadeattack_4.wav",
							"kstrudel/imps/impoff1/grenadeattack/grenadeattack_5.wav",
							"kstrudel/imps/impoff1/grenadeattack/grenadeattack_6.wav",
							"kstrudel/imps/impoff1/grenadeattack/grenadeattack_7.wav",
							"kstrudel/imps/impoff1/grenadeattack/grenadeattack_8.wav",
							"kstrudel/imps/impoff1/grenadeattack/grenadeattack_9.wav",
							"kstrudel/imps/impoff1/grenadeattack/grenadeattack_10.wav"}

ENT.SoundTbl_OnGrenadeSight = {"kstrudel/imps/impoff1/grenadesight/grenadesight_1.wav",
							"kstrudel/imps/impoff1/grenadesight/grenadesight_2.wav",
							"kstrudel/imps/impoff1/grenadesight/grenadesight_3.wav",
							"kstrudel/imps/impoff1/grenadesight/grenadesight_4.wav",
							"kstrudel/imps/impoff1/grenadesight/grenadesight_5.wav",
							"kstrudel/imps/impoff1/grenadesight/grenadesight_6.wav",
							"kstrudel/imps/impoff1/grenadesight/grenadesight_7.wav",
							"kstrudel/imps/impoff1/grenadesight/grenadesight_8.wav",
							"kstrudel/imps/impoff1/grenadesight/grenadesight_9.wav",
							"kstrudel/imps/impoff1/grenadesight/grenadesight_10.wav"}
ENT.SoundTbl_OnKilledEnemy = {}
ENT.SoundTbl_Pain = {"kstrudel/imps/impoff1/pain/pain_1.wav",
					"kstrudel/imps/impoff1/pain/pain_2.wav",
					"kstrudel/imps/impoff1/pain/pain_3.wav"}
ENT.SoundTbl_Impact = {}
ENT.SoundTbl_DamageByPlayer = {"kstrudel/imps/impoff1/pain/pain_1.wav",
					"kstrudel/imps/impoff1/pain/pain_2.wav",
					"kstrudel/imps/impoff1/pain/pain_3.wav"}
ENT.SoundTbl_Death = {"kstrudel/imps/impoff1/death/death_1.wav",
					"kstrudel/imps/impoff1/death/death_2.wav",
					"kstrudel/imps/impoff1/death/death_3.wav",
					"kstrudel/imps/impoff1/death/death_4.wav",
					"kstrudel/imps/impoff1/death/death_5.wav"}
...
function ENT:CustomOnInitialize()
	if math.random(1,0) == 1 then
		...
		self:SetBodygroup(0,math.random(0,0)) --Uniform
		self:SetBodygroup(2,math.random(0,10)) --Heads
		self:SetBodygroup(3,math.random(0,1)) --Code Cylinders
		self:SetBodygroup(4,math.random(0,2)) --Rank Bar
		self:SetBodygroup(5,math.random(0,6)) --Belt Boxes
		self:SetBodygroup(6,math.random(0,2)) --Hats
		self:SetBodygroup(7,math.random(0,0)) --Armor
		self:SetBodygroup(8,math.random(0,0)) --Keycard

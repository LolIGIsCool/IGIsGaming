...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/KriegSyntax/imperial/compnor/commando/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = ("410")
...
function ENT:CustomOnInitialize()
	if math.random(1,0) == 1 then
		...
		self:SetBodygroup(4,math.random(0,2)) -- Pauldron
		self:SetBodygroup(5,math.random(0,1)) -- Pouches
		self:SetBodygroup(6,math.random(0,0)) -- Backpack
		self:SetBodygroup(7,math.random(0,2)) -- Webbings

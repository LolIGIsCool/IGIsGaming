...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/KriegSyntax/imperial/navy/navy_officer_grand_admiral/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = ("50")
...
function ENT:CustomOnInitialize()
	if math.random(1,0) == 1 then
		...
		self:SetBodygroup(3,math.random(4,4)) --Code Cylinders
		self:SetBodygroup(4,math.random(0,0)) --Rank Bar
		self:SetBodygroup(5,math.random(0,5)) --Belt Boxes
		self:SetBodygroup(6,math.random(0,2)) --Hats
		self:SetBodygroup(7,math.random(0,0)) --Armor
		self:SetBodygroup(8,math.random(1,1)) --Epaulettes
		self:SetBodygroup(9,math.random(0,0)) --Keycard
		self:SetBodygroup(10,math.random(1,1)) --Cord
		self:SetBodygroup(11,math.random(0,1)) --Holster
	end
end

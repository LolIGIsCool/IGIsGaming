...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/KriegSyntax/imperial/stormtroopers/shoretrooper/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = ("125")
...
function ENT:CustomOnInitialize()
	if math.random(1,0) == 1 then
		...
		self:SetBodygroup(3,math.random(0,0)) -- Hats
		self:SetBodygroup(4,math.random(0,2)) -- Pouches
		self:SetBodygroup(5,math.random(0,5)) -- Webbings
		self:SetBodygroup(6,math.random(0,0)) -- Holster
	end
end

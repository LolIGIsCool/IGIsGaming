...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/KriegSyntax/rebel/navy/engineer_crew_bridge/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = ("10")
...
ENT.AnimTbl_IdleStand = {"KScrewidle01","KScrewidle02","KScrewidle03",ACT_IDLE} -- The idle animation when AI is enabled

...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/KriegSyntax/scum_and_villany/rodian/npc_male_01.mdl","models/KriegSyntax/scum_and_villany/rodian_jumpsuit/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = ("80")
...
ENT.AnimTbl_IdleStand = {"ks_idle_rebel_01"} -- The idle animation when AI is enabled
...
ENT.SoundTbl_Breath = {}
ENT.SoundTbl_Idle = {"kstrudel/scum/rodian/suspicious1.wav",
					"kstrudel/scum/rodian/suspicious2.wav",
					"kstrudel/scum/rodian/suspicious3.wav",
					"kstrudel/scum/rodian/suspicious4.wav",
					"kstrudel/scum/rodian/suspicious5.wav"}
ENT.SoundTbl_CombatIdle = {"kstrudel/scum/rodian/confuse1.wav",
					"kstrudel/scum/rodian/confuse2.wav",
					"kstrudel/scum/rodian/confuse3.wav"}
...
ENT.SoundTbl_OnPlayerSight = {"kstrudel/scum/rodian/detected1.wav",
					"kstrudel/scum/rodian/detected2.wav",
					"kstrudel/scum/rodian/detected3.wav",
					"kstrudel/scum/rodian/detected4.wav",
					"kstrudel/scum/rodian/detected5.wav"}
ENT.SoundTbl_Investigate = {}
ENT.SoundTbl_Alert = {"kstrudel/scum/rodian/escaping1.wav",
					"kstrudel/scum/rodian/escaping2.wav",
					"kstrudel/scum/rodian/escaping3.wav"}
...
ENT.SoundTbl_Pain = {"kstrudel/scum/rodian/pain25.wav",
					"kstrudel/scum/rodian/pain50.wav",
					"kstrudel/scum/rodian/pain75.wav",
					"kstrudel/scum/rodian/pain100.wav"}
ENT.SoundTbl_Impact = {}
ENT.SoundTbl_DamageByPlayer = {}
ENT.SoundTbl_Death = {"kstrudel/scum/rodian/death1.wav",
					"kstrudel/scum/rodian/death2.wav",
					"kstrudel/scum/rodian/death3.wav",
					"kstrudel/scum/rodian/death4.wav",
					"kstrudel/scum/rodian/death5.wav",
					"kstrudel/scum/rodian/death6.wav"}

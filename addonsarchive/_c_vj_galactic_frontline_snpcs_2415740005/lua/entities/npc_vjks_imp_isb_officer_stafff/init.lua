...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/KriegSyntax/imperial/compnor/comp_isb_officer_anh/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = ("50")
...
ENT.SoundTbl_Breath = {}
ENT.SoundTbl_Idle = {"kstrudel/imps/impoff3/idle/idle_1.wav",
					"kstrudel/imps/impoff3/idle/idle_2.wav",
					"kstrudel/imps/impoff3/idle/idle_3.wav",
					"kstrudel/imps/impoff3/idle/idle_4.wav",
					"kstrudel/imps/impoff3/idle/idle_5.wav",
					"kstrudel/imps/impoff3/idle/idle_6.wav",
					"kstrudel/imps/impoff3/idle/idle_7.wav",
					"kstrudel/imps/impoff3/idle/idle_8.wav",
					"kstrudel/imps/impoff3/idle/idle_9.wav",
					"kstrudel/imps/impoff3/idle/idle_10.wav",
					"kstrudel/imps/impoff3/idle/idle_11.wav",
					"kstrudel/imps/impoff3/idle/idle_12.wav",
					"kstrudel/imps/impoff3/idle/idle_13.wav"}
ENT.SoundTbl_CombatIdle = {"kstrudel/imps/impoff3/combatidle/combatidle_1.wav",
						"kstrudel/imps/impoff3/combatidle/combatidle_2.wav"}
ENT.SoundTbl_OnReceiveOrder = {"kstrudel/imps/impoff3/onrecievingorder/onrecievingorder_1.wav",
							"kstrudel/imps/impoff3/onrecievingorder/onrecievingorder_2.wav",
							"kstrudel/imps/impoff3/onrecievingorder/onrecievingorder_3.wav",
							"kstrudel/imps/impoff3/onrecievingorder/onrecievingorder_4.wav",
							"kstrudel/imps/impoff3/onrecievingorder/onrecievingorder_5.wav"}
...
ENT.SoundTbl_OnPlayerSight = {"kstrudel/imps/impoff3/onplayersight/onplayersight_1.wav",
							"kstrudel/imps/impoff3/onplayersight/onplayersight_2.wav",
							"kstrudel/imps/impoff3/onplayersight/onplayersight_3.wav",
							"kstrudel/imps/impoff3/onplayersight/onplayersight_4.wav",
							"kstrudel/imps/impoff3/onplayersight/onplayersight_5.wav",
							"kstrudel/imps/impoff3/onplayersight/onplayersight_6.wav",
							"kstrudel/imps/impoff3/onplayersight/onplayersight_7.wav",
							"kstrudel/imps/impoff3/onplayersight/onplayersight_8.wav",
							"kstrudel/imps/impoff3/onplayersight/onplayersight_9.wav"}
ENT.SoundTbl_Investigate = {"kstrudel/imps/impoff3/idle/idle_6.wav",
							"kstrudel/imps/impoff3/idle/idle_8.wav",
							"kstrudel/imps/impoff3/idle/idle_9.wav",
							"kstrudel/imps/impoff3/idle/idle_11.wav",
							"kstrudel/imps/impoff3/idle/idle_12.wav"}
ENT.SoundTbl_Alert = {"kstrudel/imps/impoff3/alert/alert_1.wav",
					"kstrudel/imps/impoff3/alert/alert_2.wav",
					"kstrudel/imps/impoff3/alert/alert_3.wav",
					"kstrudel/imps/impoff3/alert/alert_4.wav",
					"kstrudel/imps/impoff3/alert/alert_5.wav",
					"kstrudel/imps/impoff3/alert/alert_6.wav",
					"kstrudel/imps/impoff3/alert/alert_7.wav",
					"kstrudel/imps/impoff3/alert/alert_8.wav"}
ENT.SoundTbl_CallForHelp = {"kstrudel/imps/impoff3/onrecievingorder/onrecievingorder_1.wav",
							"kstrudel/imps/impoff3/onrecievingorder/onrecievingorder_2.wav",
							"kstrudel/imps/impoff3/onrecievingorder/onrecievingorder_5.wav"}
ENT.SoundTbl_BecomeEnemyToPlayer = {"kstrudel/imps/impoff3/onplayersight/onplayersight_1.wav",
							"kstrudel/imps/impoff3/onplayersight/onplayersight_2.wav",
							"kstrudel/imps/impoff3/onplayersight/onplayersight_3.wav",
							"kstrudel/imps/impoff3/onplayersight/onplayersight_4.wav",
							"kstrudel/imps/impoff3/onplayersight/onplayersight_5.wav",
							...
							"kstrudel/imps/impoff3/onplayersight/onplayersight_8.wav",
							"kstrudel/imps/impoff3/onplayersight/onplayersight_9.wav"}
ENT.SoundTbl_Suppressing = {"kstrudel/imps/impoff3/suppressing/suppressing_1.wav"}
ENT.SoundTbl_WeaponReload = {}
ENT.SoundTbl_BeforeMeleeAttack = {}
ENT.SoundTbl_MeleeAttack = {}
ENT.SoundTbl_MeleeAttackExtra = {}
ENT.SoundTbl_MeleeAttackMiss = {}
ENT.SoundTbl_GrenadeAttack = {"kstrudel/imps/impoff3/grenadeattack/grenadeattack_1.wav"}

ENT.SoundTbl_OnGrenadeSight = {"kstrudel/imps/impoff3/grenadesight/grenadesight_1.wav",
							"kstrudel/imps/impoff3/grenadesight/grenadesight_2.wav"}
ENT.SoundTbl_OnKilledEnemy = {}
ENT.SoundTbl_Pain = {"kstrudel/imps/impoff3/pain/pain_1.wav",
					"kstrudel/imps/impoff3/pain/pain_2.wav",
					"kstrudel/imps/impoff3/pain/pain_3.wav",
					"kstrudel/imps/impoff3/pain/pain_4.wav",
					"kstrudel/imps/impoff3/pain/pain_5.wav",
					"kstrudel/imps/impoff3/pain/pain_6.wav",
					"kstrudel/imps/impoff3/pain/pain_7.wav",
					"kstrudel/imps/impoff3/pain/pain_8.wav",
					"kstrudel/imps/impoff3/pain/pain_9.wav",
					"kstrudel/imps/impoff3/pain/pain_10.wav",
					"kstrudel/imps/impoff3/pain/pain_11.wav",
					"kstrudel/imps/impoff3/pain/pain_12.wav"}
ENT.SoundTbl_Impact = {}
ENT.SoundTbl_DamageByPlayer = {"kstrudel/imps/impoff3/pain/pain_1.wav",
					"kstrudel/imps/impoff3/pain/pain_2.wav",
					"kstrudel/imps/impoff3/pain/pain_3.wav",
					"kstrudel/imps/impoff3/pain/pain_4.wav",
					"kstrudel/imps/impoff3/pain/pain_5.wav",
					...
					"kstrudel/imps/impoff3/pain/pain_11.wav",
					"kstrudel/imps/impoff3/pain/pain_12.wav"}
ENT.SoundTbl_Death = {"kstrudel/imps/impoff3/death/death_1.wav",
					"kstrudel/imps/impoff3/death/death_2.wav",
					"kstrudel/imps/impoff3/death/death_3.wav"}
...
function ENT:CustomOnInitialize()
	if math.random(1,0) == 1 then
		...
		self:SetBodygroup(3,math.random(1,4)) --Code Cylinders 1
		self:SetBodygroup(4,math.random(0,4)) --Code Cylinders 2
		self:SetBodygroup(6,math.random(2,2)) --Rank Bar 1
		self:SetBodygroup(7,math.random(1,2)) --Rank Bar 2
		self:SetBodygroup(8,math.random(1,1)) --Rank Bar 3
		self:SetBodygroup(9,math.random(1,1)) --Rank Bar 4
		self:SetBodygroup(9,math.random(0,1)) --Rank Bar 4
		self:SetBodygroup(11,math.random(0,6)) --Belt Boxes
		self:SetBodygroup(12,math.random(0,2)) --Hats
		self:SetBodygroup(13,math.random(0,0)) --Armor
		self:SetBodygroup(14,math.random(0,0)) --Keycard
		self:SetBodygroup(15,math.random(0,0)) --Holster
	end
end

...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/KriegSyntax/imperial/compnor/comp_trooper/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = ("180")
...
ENT.SoundTbl_OnReceiveOrder = {"kstrudel/imps/gunner/onrecievingorder/onrecievingorder_1.wav",
							"kstrudel/imps/gunner/onrecievingorder/onrecievingorder_2.wav",
							"kstrudel/imps/gunner/onrecievingorder/onrecievingorder_3.wav"}
...
function ENT:CustomOnInitialize()
	if math.random(1,0) == 1 then
		...
		self:SetBodygroup(3,math.random(0,0)) -- Helmet
		...
		self:SetBodygroup(7,math.random(0,0)) -- Ammo Pouch
	end
end

...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/KriegSyntax/imperial/stormtroopers/jumptroopers/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = ("50")
...
ENT.AnimTbl_IdleStand = {"ks_storm_idle1","ks_storm_idle2"} -- The idle animation when AI is enabled
...
ENT.NextMoveAfterFlinchTime = "1.9" -- How much time until it can move, attack, etc. | Use this for schedules or else the base will set the time 0.6 if it sees it's a schedule!
...
ENT.CallForBackUpOnDamageAnimation = {"ks_signal_rally","ks_signal_laylow"} -- Animation used if the SNPC does the CallForBackUpOnDamage function
	-- To let the base automatically detect the animation duration, set this to false:
...
ENT.AnimTbl_WeaponAttack = {ACT_RANGE_ATTACK_SMG1, ACT_RANGE_ATTACK_RPG} -- Animation played when the SNPC does weapon attack | For VJ Weapons
...
ENT.GrenadeAttackEntity = "obj_vjks_stormgrenade" -- The entity that the SNPC throws | Half Life 2 Grenade: "npc_grenade_frag"
ENT.GrenadeAttackModel = "models/KriegSyntax/imperial/stormtroopers/storm_items/storm_grenade.mdl" -- The model for the grenade entity
	-- ====== Animation Variables ====== --
...
ENT.SoundTbl_FootStep = {"kstrudel/imps/walk_trooper_1.wav",
						"kstrudel/imps/walk_trooper_2.wav",
						"kstrudel/imps/walk_trooper_3.wav",
						"kstrudel/imps/walk_trooper_4.wav"}
ENT.SoundTbl_Breath = {}
ENT.SoundTbl_Idle = {"kstrudel/imps/storm2/idle/idle_1.wav",
					"kstrudel/imps/storm2/idle/idle_2.wav",
					"kstrudel/imps/storm2/idle/idle_3.wav",
					"kstrudel/imps/storm2/idle/idle_4.wav",
					"kstrudel/imps/storm2/idle/idle_5.wav",
					"kstrudel/imps/storm2/idle/idle_6.wav",
					"kstrudel/imps/storm2/idle/idle_7.wav",
					"kstrudel/imps/storm2/idle/idle_8.wav",
					"kstrudel/imps/storm2/idle/idle_9.wav",
					"kstrudel/imps/storm2/idle/idle_10.wav",
					"kstrudel/imps/storm2/idle/idle_11.wav",
					"kstrudel/imps/storm2/idle/idle_12.wav",
					"kstrudel/imps/storm2/idle/idle_13.wav",
					"kstrudel/imps/storm2/idle/idle_14.wav",
					"kstrudel/imps/storm2/idle/idle_15.wav",
					"kstrudel/imps/storm2/idle/idle_16.wav",
					"kstrudel/imps/storm2/idle/idle_17.wav",
					"kstrudel/imps/storm2/idle/idle_18.wav",
					"kstrudel/imps/storm2/idle/idle_19.wav",
					"kstrudel/imps/storm2/idle/idle_20.wav",
					"kstrudel/imps/storm2/idle/idle_21.wav",
					"kstrudel/imps/storm2/idle/idle_22.wav",
					"kstrudel/imps/storm2/idle/idle_23.wav",
					"kstrudel/imps/storm2/idle/idle_24.wav",
					"kstrudel/imps/storm2/idle_long/idle_01.wav",
					"kstrudel/imps/storm2/idle_long/idle_02.wav",
					"kstrudel/imps/storm2/idle_long/idle_03.wav",
					"kstrudel/imps/storm2/idle_long/idle_04.wav",
					"kstrudel/imps/storm2/idle_long/idle_05.wav",
					"kstrudel/imps/storm2/idle_long/idle_06.wav",
					"kstrudel/imps/storm2/idle_long/idle_07.wav",
					"kstrudel/imps/storm2/idle_long/idle_08.wav",
					"kstrudel/imps/storm2/idle_long/idle_09.wav",
					"kstrudel/imps/storm2/idle_long/idle_10.wav",
					"kstrudel/imps/storm2/idle_long/idle_11.wav",
					"kstrudel/imps/storm2/idle_long/idle_12.wav",
					"kstrudel/imps/storm2/idle_long/idle_13.wav",
					"kstrudel/imps/storm2/idle_long/idle_14.wav",
					"kstrudel/imps/storm2/idle_long/idle_15.wav",
					"kstrudel/imps/storm2/idle_long/idle_16.wav",
					"kstrudel/imps/storm2/idle_long/idle_17.wav",
					"kstrudel/imps/storm2/idle_long/idle_18.wav",
					"kstrudel/imps/storm2/idle_long/idle_19.wav",
					"kstrudel/imps/storm2/idle_long/idle_20.wav",
					"kstrudel/imps/storm2/idle_long/idle_21.wav",
					"kstrudel/imps/storm2/idle_long/idle_22.wav",
					"kstrudel/imps/storm2/idle_long/idle_23.wav",
					"kstrudel/imps/storm2/idle_long/idle_24.wav",
					"kstrudel/imps/storm2/idle_long/idle_25.wav",
					"kstrudel/imps/storm2/idle_long/idle_26.wav",
					"kstrudel/imps/storm2/idle_long/idle_27.wav",
					"kstrudel/imps/storm2/idle_long/idle_28.wav"}
ENT.SoundTbl_CombatIdle = {"kstrudel/imps/storm2/combatidle/combatidle_1.wav",
						"kstrudel/imps/storm2/combatidle/combatidle_2.wav",
						"kstrudel/imps/storm2/combatidle/combatidle_3.wav"}
ENT.SoundTbl_OnReceiveOrder = {"kstrudel/imps/storm2/onrecievingorder/onrecievingorder_1.wav",
							"kstrudel/imps/storm2/onrecievingorder/onrecievingorder_2.wav"}
...
ENT.SoundTbl_OnPlayerSight = {"kstrudel/imps/storm2/onplayersight/onplayersight_1.wav",
							"kstrudel/imps/storm2/onplayersight/onplayersight_2.wav",
							"kstrudel/imps/storm2/onplayersight/onplayersight_3.wav",
							"kstrudel/imps/storm2/onplayersight/onplayersight_4.wav",
							"kstrudel/imps/storm2/onplayersight/onplayersight_5.wav",
							"kstrudel/imps/storm2/onplayersight/onplayersight_6.wav",
							"kstrudel/imps/storm2/onplayersight/onplayersight_7.wav",
							"kstrudel/imps/storm2/onplayersight/onplayersight_8.wav",
							"kstrudel/imps/storm2/onplayersight/onplayersight_9.wav",
							"kstrudel/imps/storm2/onplayersight/onplayersight_10.wav",
							"kstrudel/imps/storm2/onplayersight/onplayersight_11.wav",
							"kstrudel/imps/storm2/onplayersight/onplayersight_12.wav",
							"kstrudel/imps/storm2/onplayersight/onplayersight_13.wav",
							"kstrudel/imps/storm2/onplayersight/onplayersight_14.wav",
							"kstrudel/imps/storm2/onplayersight/onplayersight_15.wav",
							"kstrudel/imps/storm2/onplayersight/onplayersight_16.wav",
							"kstrudel/imps/storm2/onplayersight/onplayersight_17.wav",
							"kstrudel/imps/storm2/onplayersight/onplayersight_18.wav",}
ENT.SoundTbl_Investigate = {"kstrudel/imps/storm2/idle/idle_22.wav",
							"kstrudel/imps/storm2/idle/idle_15.wav",
							"kstrudel/imps/storm2/idle/idle_13.wav",
							"kstrudel/imps/storm2/alert/alert_2.wav",
							"kstrudel/imps/storm2/alert/alert_3.wav"}
ENT.SoundTbl_Alert = {"kstrudel/imps/storm2/alert/alert_1.wav",
					"kstrudel/imps/storm2/alert/alert_2.wav",
					"kstrudel/imps/storm2/alert/alert_3.wav",
					"kstrudel/imps/storm2/alert/alert_4.wav",
					"kstrudel/imps/storm2/alert/alert_5.wav",
					"kstrudel/imps/storm2/alert/alert_6.wav",
					"kstrudel/imps/storm2/alert/alert_7.wav"}
ENT.SoundTbl_CallForHelp = {"kstrudel/imps/storm2/suppressing/suppressing_1.wav",
							"kstrudel/imps/storm2/suppressing/suppressing_2.wav",
							"kstrudel/imps/storm2/suppressing/suppressing_3.wav"}
ENT.SoundTbl_BecomeEnemyToPlayer = {"kstrudel/imps/storm2/onplayersight/onplayersight_1.wav",
							"kstrudel/imps/storm2/onplayersight/onplayersight_2.wav",
							"kstrudel/imps/storm2/onplayersight/onplayersight_3.wav",
							"kstrudel/imps/storm2/onplayersight/onplayersight_4.wav",
							"kstrudel/imps/storm2/onplayersight/onplayersight_5.wav",
							...
							"kstrudel/imps/storm2/onplayersight/onplayersight_17.wav",
							"kstrudel/imps/storm2/onplayersight/onplayersight_18.wav",}
ENT.SoundTbl_Suppressing = {"kstrudel/imps/storm2/suppressing/suppressing_4.wav",
							"kstrudel/imps/storm2/suppressing/suppressing_5.wav",
							"kstrudel/imps/storm2/suppressing/suppressing_6.wav",
							"kstrudel/imps/storm2/suppressing/suppressing_7.wav"}
ENT.SoundTbl_WeaponReload = {}
ENT.SoundTbl_BeforeMeleeAttack = {}
ENT.SoundTbl_MeleeAttack = {}
ENT.SoundTbl_MeleeAttackExtra = {}
ENT.SoundTbl_MeleeAttackMiss = {}
ENT.SoundTbl_GrenadeAttack = {"kstrudel/imps/storm2/grenadeattack/grenadeattack_1.wav"}

ENT.SoundTbl_OnGrenadeSight = {"kstrudel/imps/storm2/grenadesight/grenadesight_1.wav",
							"kstrudel/imps/storm2/grenadesight/grenadesight_2.wav"}
ENT.SoundTbl_OnKilledEnemy = {}
ENT.SoundTbl_Pain = {"kstrudel/imps/storm2/pain/pain_1.wav",
					"kstrudel/imps/storm2/pain/pain_2.wav",
					"kstrudel/imps/storm2/pain/pain_3.wav",
					"kstrudel/imps/storm2/pain/pain_4.wav",
					"kstrudel/imps/storm2/pain/pain_5.wav",
					"kstrudel/imps/storm2/pain/pain_6.wav",
					"kstrudel/imps/storm2/pain/pain_7.wav",
					"kstrudel/imps/storm2/pain/pain_8.wav",
					"kstrudel/imps/storm2/pain/pain_9.wav",
					"kstrudel/imps/storm2/pain/pain_10.wav",
					"kstrudel/imps/storm2/pain/pain_11.wav"}
ENT.SoundTbl_Impact = {"kstrudel/hits/impact_1.wav",
						"kstrudel/hits/impact_2.wav",
						"kstrudel/hits/impact_3.wav",
						"kstrudel/hits/impact_4.wav",
						"kstrudel/hits/impact_5.wav",
						"kstrudel/hits/impact_6.wav",
						"kstrudel/hits/impact_7.wav",
						"kstrudel/hits/impact_8.wav",
						"kstrudel/hits/impact_9.wav",
						"kstrudel/hits/impact_10.wav",
						"kstrudel/hits/impact_11.wav",
						"kstrudel/hits/impact_12.wav",}
ENT.SoundTbl_DamageByPlayer = {"kstrudel/imps/storm2/pain/pain_1.wav",
					"kstrudel/imps/storm2/pain/pain_2.wav",
					"kstrudel/imps/storm2/pain/pain_3.wav",
					"kstrudel/imps/storm2/pain/pain_4.wav",
					"kstrudel/imps/storm2/pain/pain_5.wav",
					...
					"kstrudel/imps/storm2/pain/pain_10.wav",
					"kstrudel/imps/storm2/pain/pain_11.wav"}
ENT.SoundTbl_Death = {"kstrudel/imps/storm2/death/death_1.wav",
					"kstrudel/imps/storm2/death/death_2.wav",
					"kstrudel/imps/storm2/death/death_3.wav"}
					
					
function ENT:CustomOnInitialize()
	if math.random(1,0) == 1 then
		self:SetBodygroup(0,math.random(0,0)) -- Body
		self:SetBodygroup(1,math.random(0,2)) -- Pauldron
		self:SetBodygroup(3,math.random(0,18)) -- Head
		self:SetBodygroup(4,math.random(0,0)) -- Hats
		self:SetBodygroup(5,math.random(0,3)) -- Pouches
		self:SetBodygroup(6,math.random(0,2)) -- Webbings
		self:SetBodygroup(7,math.random(1,1)) -- Backpacks
		self:SetBodygroup(8,math.random(0,0)) -- Holster
	end
end
...
ENT.CanJetpackJump = true
ENT.JetpackJump_NextT = 0
ENT.JetpackJump_Nexttime = 2
ENT.JetpackJump_activated = 0
ENT.JetpackJump_jumping = 0
ENT.JetpackJump_durationT = 0
ENT.JetpackJump_duration = 5.0
ENT.JetpackJump_Chance = 5
ENT.JetpackJump_anim = "vjseq_Jump_Holding_Glide"
ENT.JetpackJump_landanim = "vjseq_jump_holding_land"
ENT.JetpackJump_Rangemin = 200
ENT.JetpackJump_Rangemax = 88000
ENT.JetpackJump_Range = 88000
ENT.JetpackJump_Rangeclose = 150
ENT.JetpackJump_Cooldown = 3
ENT.JetpackJump_originalgravity = 1
ENT.JetpackJump_originalmovetype = VJ_MOVETYPE_GROUND
ENT.SoundTbl_JetpackSound = {"jetpack/jetpack3.mp3"}
ENT.JetpackJump_originaldragn = 0
ENT.JetpackJump_originaldrag = true
ENT.JetpackJump_originalflinch = 1
ENT.JetpackJump_originalenemy = NULL
ENT.JetpackJump_originalmelee = true

ENT.JetpackJumpEscape_Nexttime = 2
ENT.JetpackJumpEscape_NextT = 0
ENT.JetpackJumpEscape_activated = 0
ENT.JetpackJumpEscape_recharge = 1




--Jetpack Code, PanzerElite

ENT.CanFlyingCorpse = true
ENT.FlyingCorpse_Chance = 55
...
function ENT:CustomOnDeath_AfterCorpseSpawned(dmginfo,hitgroup,GetCorpse)
	...
	if IsValid(self.droppedhelmet) then
		...
		if IsValid(gunnercorpse) then table.insert(GetCorpse.ExtraCorpsesToRemove,gunnercorpse)
		end
	end
	end
...
function ENT:CustomOnTakeDamage_AfterDamage(dmginfo,hitgroup) 
	...
	if self:IsOnFire() then
		...
		self.AnimTbl_Death = {"Standing_OnFire"}
	end

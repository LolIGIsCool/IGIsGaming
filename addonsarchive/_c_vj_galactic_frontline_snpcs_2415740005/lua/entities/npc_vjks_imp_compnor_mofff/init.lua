...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/KriegSyntax/imperial/compnor/moff/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = ("50")
...
ENT.SoundTbl_Breath = {}
ENT.SoundTbl_Idle = {"kstrudel/imps/moff/idle/idle_1.wav",
					"kstrudel/imps/moff/idle/idle_2.wav",
					"kstrudel/imps/moff/idle/idle_3.wav",
					"kstrudel/imps/moff/idle/idle_4.wav",
					"kstrudel/imps/moff/idle/idle_5.wav",
					"kstrudel/imps/moff/idle/idle_6.wav",
					"kstrudel/imps/moff/idle/idle_7.wav",
					"kstrudel/imps/moff/idle/idle_8.wav",
					"kstrudel/imps/moff/idle/idle_9.wav"}
ENT.SoundTbl_CombatIdle = {"kstrudel/imps/moff/combatidle/combatidle_1.wav",
						"kstrudel/imps/moff/combatidle/combatidle_2.wav",
						"kstrudel/imps/moff/combatidle/combatidle_3.wav",
						"kstrudel/imps/moff/combatidle/combatidle_4.wav"}
ENT.SoundTbl_OnReceiveOrder = {"kstrudel/imps/moff/onrecievingorder/onrecievingorder_1.wav",
							"kstrudel/imps/moff/onrecievingorder/onrecievingorder_2.wav"}
...
ENT.SoundTbl_OnPlayerSight = {"kstrudel/imps/moff/onplayersight/onplayersight_1.wav",
							"kstrudel/imps/moff/onplayersight/onplayersight_2.wav",
							"kstrudel/imps/moff/onplayersight/onplayersight_3.wav",
							"kstrudel/imps/moff/onplayersight/onplayersight_4.wav"}
ENT.SoundTbl_Investigate = {"kstrudel/imps/moff/combatidle/combatidle_1.wav",
						"kstrudel/imps/moff/combatidle/combatidle_2.wav",
						"kstrudel/imps/moff/combatidle/combatidle_3.wav",
						"kstrudel/imps/moff/combatidle/combatidle_4.wav"}
ENT.SoundTbl_Alert = {"kstrudel/imps/moff/alert/alert_1.wav",
					"kstrudel/imps/moff/alert/alert_2.wav",
					"kstrudel/imps/moff/alert/alert_3.wav",
					"kstrudel/imps/moff/alert/alert_4.wav",
					"kstrudel/imps/moff/alert/alert_5.wav"}
ENT.SoundTbl_CallForHelp = {"kstrudel/imps/moff/suppressing/suppressing_1.wav","kstrudel/imps/moff/suppressing/suppressing_1.wav"}
ENT.SoundTbl_BecomeEnemyToPlayer = {"kstrudel/imps/moff/onplayersight/onplayersight_1.wav",
							"kstrudel/imps/moff/onplayersight/onplayersight_2.wav",
							"kstrudel/imps/moff/onplayersight/onplayersight_3.wav",
							"kstrudel/imps/moff/onplayersight/onplayersight_4.wav",
							"kstrudel/imps/moff/onplayersight/onplayersight_5.wav",
							"kstrudel/imps/moff/onplayersight/onplayersight_6.wav",
							"kstrudel/imps/moff/onplayersight/onplayersight_7.wav",
							"kstrudel/imps/moff/onplayersight/onplayersight_8.wav",
							"kstrudel/imps/moff/onplayersight/onplayersight_9.wav",
							"kstrudel/imps/moff/onplayersight/onplayersight_10.wav",
							"kstrudel/imps/moff/onplayersight/onplayersight_11.wav",
							"kstrudel/imps/moff/onplayersight/onplayersight_12.wav"}
ENT.SoundTbl_WeaponReload = {}
ENT.SoundTbl_BeforeMeleeAttack = {}
ENT.SoundTbl_MeleeAttack = {}
ENT.SoundTbl_MeleeAttackExtra = {}
ENT.SoundTbl_MeleeAttackMiss = {}
ENT.SoundTbl_GrenadeAttack = {"kstrudel/imps/moff/grenadeattack/grenadeattack_1.wav",
							"kstrudel/imps/moff/grenadeattack/grenadeattack_2.wav"}

ENT.SoundTbl_OnGrenadeSight = {"kstrudel/imps/moff/grenadesight/grenadesight_1.wav",
							"kstrudel/imps/moff/grenadesight/grenadesight_2.wav",
							"kstrudel/imps/moff/grenadesight/grenadesight_3.wav"}
ENT.SoundTbl_OnKilledEnemy = {}
ENT.SoundTbl_Pain = {"kstrudel/imps/moff/pain/pain_1.wav",
					"kstrudel/imps/moff/pain/pain_2.wav",
					"kstrudel/imps/moff/pain/pain_3.wav"}
ENT.SoundTbl_Impact = {}
ENT.SoundTbl_DamageByPlayer = {"kstrudel/imps/moff/pain/pain_1.wav",
					"kstrudel/imps/moff/pain/pain_2.wav",
					"kstrudel/imps/moff/pain/pain_3.wav",
					"kstrudel/imps/moff/pain/pain_4.wav",
					"kstrudel/imps/moff/pain/pain_5.wav"}
ENT.SoundTbl_Death = {"kstrudel/imps/moff/death/death_1.wav",
					"kstrudel/imps/moff/death/death_2.wav",
					"kstrudel/imps/moff/death/death_3.wav",
					"kstrudel/imps/moff/death/death_4.wav",
					"kstrudel/imps/moff/death/death_5.wav",
					"kstrudel/imps/moff/death/death_6.wav"}
...
function ENT:CustomOnInitialize()
	if math.random(1,0) == 1 then
		...
		self:SetBodygroup(3,math.random(0,4)) --Code Cylinders
		self:SetBodygroup(4,math.random(0,1)) --Rank Bar
		...
		self:SetBodygroup(9,math.random(0,0)) --Holster
	end
end

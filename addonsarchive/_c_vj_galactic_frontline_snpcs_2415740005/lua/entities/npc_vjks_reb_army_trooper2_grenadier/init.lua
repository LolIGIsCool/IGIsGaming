...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/KriegSyntax/rebel/army/army_trooper2/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = ("120")
...
function ENT:CustomOnInitialize()
	if math.random(1,0) == 1 then
		...
		self:SetBodygroup(0,math.random(0,9)) -- Hats
		self:SetBodygroup(2,math.random(0,18)) -- Heads
		self:SetBodygroup(3,math.random(0,8)) -- Tunics
		self:SetBodygroup(4,math.random(0,12)) -- Ranks
		self:SetBodygroup(5,math.random(0,1)) -- Pants

...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/KriegSyntax/scum_and_villany/weequay/npc_male_01.mdl","models/KriegSyntax/scum_and_villany/weequay_jumpsuit/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = ("80")
...
ENT.SoundTbl_Breath = {}
ENT.SoundTbl_Idle = {"kstrudel/scum/weequay/confuse2.wav",
					"kstrudel/scum/weequay/confuse3.wav"}
ENT.SoundTbl_CombatIdle = {"kstrudel/scum/weequay/confuse2.wav",
					"kstrudel/scum/weequay/confuse3.wav"}
...
ENT.SoundTbl_OnPlayerSight = {"kstrudel/scum/weequay/confuse1.wav"}
ENT.SoundTbl_Investigate = {}
ENT.SoundTbl_Alert = {"kstrudel/scum/weequay/escaping1.wav",
					"kstrudel/scum/weequay/escaping2.wav",
					"kstrudel/scum/weequay/escaping3.wav"}
...
ENT.SoundTbl_Pain = {"kstrudel/scum/weequay/pain25.wav",
					"kstrudel/scum/weequay/pain50.wav",
					"kstrudel/scum/weequay/pain75.wav",
					"kstrudel/scum/weequay/pain100.wav"}
ENT.SoundTbl_Impact = {}
ENT.SoundTbl_DamageByPlayer = {}
ENT.SoundTbl_Death = {"kstrudel/scum/weequay/death1.wav",
					"kstrudel/scum/weequay/death2.wav",
					"kstrudel/scum/weequay/death3.wav"}

...
ENT.AnimTbl_WeaponAttack = {ACT_RANGE_ATTACK_SMG1} -- Animation played when the SNPC does weapon attack | For VJ Weapons
...
ENT.AnimTbl_WeaponAttackCrouch = {ACT_RANGE_ATTACK_SMG1_LOW} -- Animation played when the SNPC does weapon attack while crouching | For VJ Weapons
...
ENT.AnimTbl_MeleeChargeAttack = {ACT_MELEE_ATTACK1}

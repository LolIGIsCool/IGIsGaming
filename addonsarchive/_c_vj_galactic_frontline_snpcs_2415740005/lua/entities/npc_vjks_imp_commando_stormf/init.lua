...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/KriegSyntax/imperial/compnor/commando_storm/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = ("410")
...
ENT.SoundTbl_Breath = {}
ENT.SoundTbl_Idle = {"kstrudel/imps/commando_radio_1.ogg",
					"kstrudel/imps/commando_radio_2.ogg",
					"kstrudel/imps/commando_radio_3.ogg",
					"kstrudel/imps/commando_radio_4.ogg",
					"kstrudel/imps/commando_radio_5.ogg",
					"kstrudel/imps/commando_radio_6.ogg"}
...
function ENT:CustomOnInitialize()
	if math.random(1,0) == 1 then
		...
		self:SetBodygroup(6,math.random(0,6)) -- Webbings

...
ENT.SoundTbl_Impact = {"kstrudel/imps/bodyfall_trooper1.wav"}
...
function ENT:CustomOnInitialize()
	if math.random(1,0) == 1 then
		...
		self:SetBodygroup(1,math.random(0,1)) -- Pauldron
		self:SetBodygroup(3,math.random(0,18)) -- Head
		self:SetBodygroup(4,math.random(0,2)) -- Hats
		self:SetBodygroup(5,math.random(0,2)) -- Pouches
		self:SetBodygroup(6,math.random(0,2)) -- Webbings
		self:SetBodygroup(7,math.random(5,5)) -- Backpacks

...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/KriegSyntax/imperial/navy/navy_gunner/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = ("100")
...
ENT.SoundTbl_Breath = {}
ENT.SoundTbl_Idle = {"kstrudel/imps/navytroopoff/idle/idle_1.wav",
					"kstrudel/imps/navytroopoff/idle/idle_2.wav",
					"kstrudel/imps/navytroopoff/idle/idle_3.wav"}
ENT.SoundTbl_CombatIdle = {}
ENT.SoundTbl_OnReceiveOrder = {"kstrudel/imps/navytroopoff/onrecievingorder/onrecievingorder_1.wav",
							"kstrudel/imps/navytroopoff/onrecievingorder/onrecievingorder_2.wav",
							"kstrudel/imps/navytroopoff/onrecievingorder/onrecievingorder_3.wav"}
...
ENT.SoundTbl_OnPlayerSight = {"kstrudel/imps/navytroopoff/onplayersight/onplayersight_1.wav",
							"kstrudel/imps/navytroopoff/onplayersight/onplayersight_2.wav",
							"kstrudel/imps/navytroopoff/onplayersight/onplayersight_3.wav",
							"kstrudel/imps/navytroopoff/onplayersight/onplayersight_4.wav",
							"kstrudel/imps/navytroopoff/onplayersight/onplayersight_5.wav",
							"kstrudel/imps/navytroopoff/onplayersight/onplayersight_6.wav",
							"kstrudel/imps/navytroopoff/onplayersight/onplayersight_7.wav",
							"kstrudel/imps/navytroopoff/onplayersight/onplayersight_8.wav",
							"kstrudel/imps/navytroopoff/onplayersight/onplayersight_9.wav"}
ENT.SoundTbl_Investigate = {"kstrudel/imps/navytroopoff/alert/alert_1.wav",
							"kstrudel/imps/navytroopoff/alert/alert_2.wav",
							"kstrudel/imps/navytroopoff/alert/alert_3.wav",
							"kstrudel/imps/navytroopoff/alert/alert_4.wav",
							"kstrudel/imps/navytroopoff/alert/alert_5.wav",
							"kstrudel/imps/navytroopoff/alert/alert_6.wav",
							"kstrudel/imps/navytroopoff/alert/alert_7.wav",
							"kstrudel/imps/navytroopoff/alert/alert_8.wav",
							"kstrudel/imps/navytroopoff/alert/alert_9.wav"}
ENT.SoundTbl_Alert = {"kstrudel/imps/navytroopoff/alert/alert_1.wav",
					"kstrudel/imps/navytroopoff/alert/alert_2.wav",
					"kstrudel/imps/navytroopoff/alert/alert_3.wav",
					"kstrudel/imps/navytroopoff/alert/alert_4.wav",
					"kstrudel/imps/navytroopoff/alert/alert_5.wav",
					...
					"kstrudel/imps/navytroopoff/alert/alert_8.wav",
					"kstrudel/imps/navytroopoff/alert/alert_9.wav"}
ENT.SoundTbl_CallForHelp = {"kstrudel/imps/navytroopoff/onrecievingorder/onrecievingorder_1.wav",
							"kstrudel/imps/navytroopoff/onrecievingorder/onrecievingorder_2.wav",
							"kstrudel/imps/navytroopoff/onrecievingorder/onrecievingorder_3.wav"}
ENT.SoundTbl_BecomeEnemyToPlayer = {"kstrudel/imps/navytroopoff/onplayersight/onplayersight_1.wav",
							"kstrudel/imps/navytroopoff/onplayersight/onplayersight_2.wav",
							"kstrudel/imps/navytroopoff/onplayersight/onplayersight_3.wav",
							"kstrudel/imps/navytroopoff/onplayersight/onplayersight_4.wav",
							"kstrudel/imps/navytroopoff/onplayersight/onplayersight_5.wav",
							...
							"kstrudel/imps/navytroopoff/onplayersight/onplayersight_8.wav",
							"kstrudel/imps/navytroopoff/onplayersight/onplayersight_9.wav"}
ENT.SoundTbl_Suppressing = {"kstrudel/imps/navytroopoff/suppressing/suppressing_1.wav",
							"kstrudel/imps/navytroopoff/suppressing/suppressing_2.wav",
							"kstrudel/imps/navytroopoff/suppressing/suppressing_3.wav"}
ENT.SoundTbl_WeaponReload = {}
ENT.SoundTbl_BeforeMeleeAttack = {}
ENT.SoundTbl_MeleeAttack = {}
ENT.SoundTbl_MeleeAttackExtra = {}
ENT.SoundTbl_MeleeAttackMiss = {}
ENT.SoundTbl_GrenadeAttack = {"kstrudel/imps/navytroopoff/grenadeattack/grenadeattack_1.wav",
							"kstrudel/imps/navytroopoff/grenadeattack/grenadeattack_2.wav"}

ENT.SoundTbl_OnGrenadeSight = {}
ENT.SoundTbl_OnKilledEnemy = {}
ENT.SoundTbl_Pain = {"kstrudel/imps/navytroopoff/pain/pain_1.wav",
					"kstrudel/imps/navytroopoff/pain/pain_2.wav",
					"kstrudel/imps/navytroopoff/pain/pain_3.wav",
					"kstrudel/imps/navytroopoff/pain/pain_4.wav",
					"kstrudel/imps/navytroopoff/pain/pain_5.wav",
					"kstrudel/imps/navytroopoff/pain/pain_6.wav",
					"kstrudel/imps/navytroopoff/pain/pain_7.wav",
					"kstrudel/imps/navytroopoff/pain/pain_8.wav",
					"kstrudel/imps/navytroopoff/pain/pain_9.wav",
					"kstrudel/imps/navytroopoff/pain/pain_10.wav",
					"kstrudel/imps/navytroopoff/pain/pain_11.wav"}
ENT.SoundTbl_Impact = {}
ENT.SoundTbl_DamageByPlayer = {"kstrudel/imps/navytroopoff/pain/pain_1.wav",
					"kstrudel/imps/navytroopoff/pain/pain_2.wav",
					"kstrudel/imps/navytroopoff/pain/pain_3.wav",
					"kstrudel/imps/navytroopoff/pain/pain_4.wav",
					"kstrudel/imps/navytroopoff/pain/pain_5.wav",
					...
					"kstrudel/imps/navytroopoff/pain/pain_10.wav",
					"kstrudel/imps/navytroopoff/pain/pain_11.wav"}
ENT.SoundTbl_Death = {"kstrudel/imps/navytroopoff/death/death_1.wav",
					"kstrudel/imps/navytroopoff/death/death_2.wav",
					"kstrudel/imps/navytroopoff/death/death_3.wav",
					"kstrudel/imps/navytroopoff/death/death_4.wav",
					"kstrudel/imps/navytroopoff/death/death_5.wav",
					"kstrudel/imps/navytroopoff/death/death_6.wav"}
...
function ENT:CustomOnInitialize()
	if math.random(1,0) == 1 then
		self:SetBodygroup(1,math.random(0,1)) -- Uniform
		self:SetBodygroup(2,math.random(0,10)) -- Heads
		self:SetBodygroup(3,math.random(1,2)) -- Hat
		self:SetBodygroup(6,math.random(0,6)) -- Belt Boxes
		self:SetBodygroup(7,math.random(0,2)) -- Holster
	end
end

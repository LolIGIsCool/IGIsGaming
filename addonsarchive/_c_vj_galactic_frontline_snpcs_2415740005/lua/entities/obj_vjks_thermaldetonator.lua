...
ENT.PrintName		= "[VJKS] Thermal Detonator"
ENT.Author 			= "DrVrej"
...
if (CLIENT) then
	local Name = "Imperial Thermal Detonator"
	local LangName = "obj_vjks_thermaldetonator"
...
ENT.Model = {"models/kriegsyntax/weapons/detonator_thermal/detonator_thermal.mdl"} -- The models it should spawn with | Picks a random one from the table
...
--	util.Effect( "HelicopterMegaBomb", effectdata )
	...
	util.Effect( "vjks_sw_effect_thermal_detonator", effectdata )

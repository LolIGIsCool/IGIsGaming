...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/KriegSyntax/imperial/stormtroopers/sarctrooper/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = ("180")
...
ENT.GrenadeAttackEntity = "obj_vjks_smokedetonator" -- The entity that the SNPC throws | Half Life 2 Grenade: "npc_grenade_frag"
ENT.GrenadeAttackModel = "models/kriegsyntax/weapons/detonator_smoke/detonator_smoke.mdl" -- The model for the grenade entity
	-- ====== Animation Variables ====== --
...
ENT.ThrowGrenadeChance = 5 -- Chance that it will throw the grenade | Set to 1 to throw all the time
...
function ENT:CustomOnInitialize()
	if math.random(1,0) == 1 then
		...
		self:SetBodygroup(2,math.random(0,18)) -- Head
		self:SetBodygroup(3,math.random(0,0)) -- Hat
		self:SetBodygroup(4,math.random(0,2)) -- Pouch
		self:SetBodygroup(5,math.random(0,0)) -- Pauldron
		self:SetBodygroup(6,math.random(0,0)) -- Backpack
		self:SetBodygroup(7,math.random(6,6)) -- Webbings

...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/KriegSyntax/imperial/army/army_trooper/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = ("130")
...
function ENT:CustomOnInitialize()
	if math.random(1,0) == 1 then
		...
		self:SetBodygroup(4,math.random(0,2)) -- Pants
		self:SetBodygroup(5,math.random(0,0)) -- Backpack
		self:SetBodygroup(6,math.random(0,3)) -- Webbings
		self:SetBodygroup(7,math.random(1,2)) -- Ammo Pouch
	end
end

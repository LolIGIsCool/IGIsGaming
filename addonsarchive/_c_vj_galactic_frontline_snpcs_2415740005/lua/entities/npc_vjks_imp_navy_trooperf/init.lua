...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/KriegSyntax/imperial/navy/navy_trooper/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = ("50")
...
ENT.AnimTbl_IdleStand = {"KSntidle01"} -- The idle animation when AI is enabled
...
ENT.SoundTbl_OnReceiveOrder = {"kstrudel/imps/navytroop/onrecievingorder/onrecievingorder_1.wav",
							"kstrudel/imps/navytroop/onrecievingorder/onrecievingorder_2.wav",
							"kstrudel/imps/navytroop/onrecievingorder/onrecievingorder_3.wav"}
...
ENT.SoundTbl_OnPlayerSight = {"kstrudel/imps/navytroop/onplayersight/onplayersight_1.wav",
							"kstrudel/imps/navytroop/onplayersight/onplayersight_2.wav",
							"kstrudel/imps/navytroop/onplayersight/onplayersight_3.wav",
							"kstrudel/imps/navytroop/onplayersight/onplayersight_4.wav",
							"kstrudel/imps/navytroop/onplayersight/onplayersight_5.wav",
							"kstrudel/imps/navytroop/onplayersight/onplayersight_6.wav",
							"kstrudel/imps/navytroop/onplayersight/onplayersight_7.wav",
							"kstrudel/imps/navytroop/onplayersight/onplayersight_8.wav",
							"kstrudel/imps/navytroop/onplayersight/onplayersight_9.wav"}
...
ENT.SoundTbl_Alert = {"kstrudel/imps/navytroop/alert/alert_1.wav",
					"kstrudel/imps/navytroop/alert/alert_2.wav",
					"kstrudel/imps/navytroop/alert/alert_3.wav",
					"kstrudel/imps/navytroop/alert/alert_4.wav",
					"kstrudel/imps/navytroop/alert/alert_5.wav",
					...
					"kstrudel/imps/navytroop/alert/alert_8.wav",
					"kstrudel/imps/navytroop/alert/alert_9.wav"}
ENT.SoundTbl_CallForHelp = {"kstrudel/imps/navytroop/onrecievingorder/onrecievingorder_1.wav",
							"kstrudel/imps/navytroop/onrecievingorder/onrecievingorder_2.wav",
							"kstrudel/imps/navytroop/onrecievingorder/onrecievingorder_3.wav"}
ENT.SoundTbl_BecomeEnemyToPlayer = {"kstrudel/imps/navytroop/onplayersight/onplayersight_1.wav",
							"kstrudel/imps/navytroop/onplayersight/onplayersight_2.wav",
							"kstrudel/imps/navytroop/onplayersight/onplayersight_3.wav",
							"kstrudel/imps/navytroop/onplayersight/onplayersight_4.wav",
							"kstrudel/imps/navytroop/onplayersight/onplayersight_5.wav",
							...
							"kstrudel/imps/navytroop/onplayersight/onplayersight_8.wav",
							"kstrudel/imps/navytroop/onplayersight/onplayersight_9.wav"}
ENT.SoundTbl_Suppressing = {"kstrudel/imps/navytroop/suppressing/suppressing_1.wav",
							"kstrudel/imps/navytroop/suppressing/suppressing_2.wav",
							"kstrudel/imps/navytroop/suppressing/suppressing_3.wav"}
ENT.SoundTbl_WeaponReload = {}
ENT.SoundTbl_BeforeMeleeAttack = {}
ENT.SoundTbl_MeleeAttack = {}
ENT.SoundTbl_MeleeAttackExtra = {}
ENT.SoundTbl_MeleeAttackMiss = {}
ENT.SoundTbl_GrenadeAttack = {"kstrudel/imps/navytroop/grenadeattack/grenadeattack_1.wav",
							"kstrudel/imps/navytroop/grenadeattack/grenadeattack_2.wav"}

ENT.SoundTbl_OnGrenadeSight = {}
ENT.SoundTbl_OnKilledEnemy = {}
ENT.SoundTbl_Pain = {"kstrudel/imps/navytroop/pain/pain_1.wav",
					"kstrudel/imps/navytroop/pain/pain_2.wav",
					"kstrudel/imps/navytroop/pain/pain_3.wav",
					"kstrudel/imps/navytroop/pain/pain_4.wav",
					"kstrudel/imps/navytroop/pain/pain_5.wav",
					"kstrudel/imps/navytroop/pain/pain_6.wav",
					"kstrudel/imps/navytroop/pain/pain_7.wav",
					"kstrudel/imps/navytroop/pain/pain_8.wav",
					"kstrudel/imps/navytroop/pain/pain_9.wav",
					"kstrudel/imps/navytroop/pain/pain_10.wav",
					"kstrudel/imps/navytroop/pain/pain_11.wav"}
ENT.SoundTbl_Impact = {}
ENT.SoundTbl_DamageByPlayer = {"kstrudel/imps/navytroop/pain/pain_1.wav",
					"kstrudel/imps/navytroop/pain/pain_2.wav",
					"kstrudel/imps/navytroop/pain/pain_3.wav",
					"kstrudel/imps/navytroop/pain/pain_4.wav",
					"kstrudel/imps/navytroop/pain/pain_5.wav",
					...
					"kstrudel/imps/navytroop/pain/pain_10.wav",
					"kstrudel/imps/navytroop/pain/pain_11.wav"}
ENT.SoundTbl_Death = {"kstrudel/imps/navytroop/death/death_1.wav",
					"kstrudel/imps/navytroop/death/death_2.wav",
					"kstrudel/imps/navytroop/death/death_3.wav",
					"kstrudel/imps/navytroop/death/death_4.wav",
					"kstrudel/imps/navytroop/death/death_5.wav",
					"kstrudel/imps/navytroop/death/death_6.wav"}
...
function ENT:CustomOnInitialize()
	if math.random(1,0) == 1 then
		...
		self:SetBodygroup(3,math.random(0,2)) -- Belt Boxes
		self:SetBodygroup(4,math.random(0,1)) -- Helmet
		self:SetBodygroup(5,math.random(0,0)) -- Armor
		self:SetBodygroup(6,math.random(0,0)) -- Keycard

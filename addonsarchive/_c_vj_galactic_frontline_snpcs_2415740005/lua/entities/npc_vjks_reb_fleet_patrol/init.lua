...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/KriegSyntax/rebel/navy/fleet_crew/npc_male_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = ("10")
...
function ENT:CustomOnInitialize()
	if math.random(1,0) == 1 then
		self:SetBodygroup(0,math.random(2,7))
		self:SetBodygroup(2,math.random(0,18))
		self:SetBodygroup(3,math.random(2,7))

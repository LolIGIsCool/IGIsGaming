...
SWEP.NPC_TimeUntilFire	 		= 1.0 -- How much time until the bullet/projectile is fired?
...
SWEP.NPC_BeforeFireSoundPitch = VJ_Set(100, 100) -- How much time until the secondary fire can be used again?
	-- ====== Reload Variables ====== --
...
SWEP.WorldModel					= "models/kriegsyntax/weapons/blastech_dh17/blastech_dh17.mdl" 
SWEP.WorldModel					= "models/kriegsyntax/weapons/blastech_dh17/blastech_dh17.mdl" -- The world model (Third person, when a NPC is holding it, on ground, etc.)
...
SWEP.Primary.ClipSizeReload		= 9 -- If there is x amount of bullets left in the clip, then reload
...
SWEP.Primary.Delay				= 1.0 -- Time until it can shoot again
...
SWEP.Primary.Sound				= {"weapons/dh17/dh17_blasfire_01.ogg","weapons/dh17/dh17_blasfire_02.ogg","weapons/dh17/dh17_blasfire_03.ogg","weapons/dh17/dh17_blasfire_04.ogg",
									"weapons/dh17/dh17_blasfire_05.ogg",
									"weapons/dh17/dh17_blasfire_06.ogg",
									"weapons/dh17/dh17_blasfire_07.ogg"}
SWEP.Primary.HasDistantSound	= true -- Does it have a distant sound when the gun is shot?
SWEP.Primary.DistantSound		= "weapons/dh17/dh17_distant_1.wav"

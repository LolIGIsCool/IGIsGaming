...
SWEP.PrintName					= "Imperial Holdout Pistol"
...
SWEP.WorldModel					= "models/kriegsyntax/weapons/blastech_se09e/blastech_se09e.mdl" 
SWEP.WorldModel					= "models/kriegsyntax/weapons/blastech_se09e/blastech_se09e.mdl" -- The world model (Third person, when a NPC is holding it, on ground, etc.)

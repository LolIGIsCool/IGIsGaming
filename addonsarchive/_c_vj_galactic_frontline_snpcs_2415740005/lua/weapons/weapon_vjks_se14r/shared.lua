...
SWEP.PrintName					= "SE14r Imperial-Issue Sidearm"
...
SWEP.WorldModel					= "models/kriegsyntax/weapons/blastech_se14r/blastech_se14r.mdl" 
SWEP.WorldModel					= "models/kriegsyntax/weapons/blastech_se14r/blastech_se14r.mdl" -- The world model (Third person, when a NPC is holding it, on ground, etc.)
...
SWEP.Primary.Force				= 27 -- Force applied on the object the bullet hits
...
SWEP.Primary.Sound				= "weapons/se14c/se14c_fire.ogg"
SWEP.Primary.HasDistantSound	= true -- Does it have a distant sound when the gun is shot?
SWEP.Primary.DistantSound		= "weapons/se14c/se14c_fire.ogg"

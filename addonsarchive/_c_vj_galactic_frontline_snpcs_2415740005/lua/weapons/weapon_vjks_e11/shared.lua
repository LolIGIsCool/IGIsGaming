...
SWEP.WorldModel					= "models/kriegsyntax/weapons/blastech_e11/blastech_e11.mdl" 
SWEP.WorldModel					= "models/kriegsyntax/weapons/blastech_e11/blastech_e11.mdl" -- The world model (Third person, when a NPC is holding it, on ground, etc.)
...
SWEP.AnimTbl_Idle				= {ACT_IDLE_SMG1_RELAXED}
SWEP.NextIdle_Deploy			= 0.5 -- How much time until it plays the idle animation after the weapon gets deployed
SWEP.HasDeploySound = true -- Does the weapon have a deploy sound?
SWEP.DeploySound = {"weapons/blaster_reload.ogg"} -- Sound played when the weapon is deployed

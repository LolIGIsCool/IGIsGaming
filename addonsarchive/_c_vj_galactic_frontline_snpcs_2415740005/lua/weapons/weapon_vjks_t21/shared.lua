...
SWEP.NPC_ReloadSoundLevel = 60 -- How far does the sound go?
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.WorldModel					= "models/kriegsyntax/weapons/blastech_t21/blastech_t21.mdl" 
SWEP.WorldModel					= "models/kriegsyntax/weapons/blastech_t21/blastech_t21.mdl" -- The world model (Third person, when a NPC is holding it, on ground, etc.)
SWEP.HoldType 					= "smg"
...
SWEP.Primary.Force				= 50 -- Force applied on the object the bullet hits
SWEP.Primary.NumberOfShots		= 1 -- How many shots per attack?
SWEP.Primary.ClipSize			= 30 -- Max amount of bullets per clip
SWEP.Primary.ClipSizeReload		= 10 -- If there is x amount of bullets left in the clip, then reload

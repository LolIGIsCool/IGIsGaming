...
SWEP.ViewModel					= "models/kriegsyntax/weapons/blastech_tc_55/blastech_tc_55.mdl" -- The view model (First person)
SWEP.WorldModel					= "models/kriegsyntax/weapons/blastech_tc_55/blastech_tc_55.mdl" -- The world model (Third person, when a NPC is holding it, on ground, etc.)

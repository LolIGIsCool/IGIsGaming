...
SWEP.NPC_CustomSpread	 		= 10
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.WorldModel					= "models/kriegsyntax/weapons/blastech_smartrocket/blastech_smartrocket.mdl" 
SWEP.WorldModel					= "models/kriegsyntax/weapons/blastech_smartrocket/blastech_smartrocket.mdl" -- The world model (Third person, when a NPC is holding it, on ground, etc.)
SWEP.HoldType 					= "rpg"
...
function SWEP:CustomOnPrimaryAttack_BeforeShoot()
	...
	if IsValid(phys) then
		if self:GetOwner():IsPlayer() then
			phys:SetVelocity(self:GetOwner():GetAimVector() * 4500)
		else

...
function EFFECT:Init( data )
	...
	if( emitter ) then
		...
		for i = 1,5 do
			...
			smoke1:SetStartSize(math.Rand(150,280)) -- Size of the effect
			smoke1:SetEndSize(math.Rand(380,460)) -- Size of the effect at the end (The effect slowly trasnsforms to this size)
		...
		FlashS:SetStartSize( math.Rand( 240, 360 ) );
		...
		for i = 1, 1 do
			...
			particleS1:SetStartSize( math.Rand( 41, 186 ) );
		...
		for i = 1, 10 do
			...
			particleS2:SetVelocity ( self.DirVec * math.random(0,800)*self.Scale + VectorRand():GetNormalized() * math.random(0,800)*self.Scale );
			particleS2:SetDieTime( math.Rand( 0.1, 7.5 ) );
			particleS2:SetStartAlpha( 255 );
			particleS2:SetEndAlpha( 0 );
			particleS2:SetStartSize( math.Rand( 0.5, 3 ) );
		...
		for i = 1, 55 do
			...
			floatingP1:SetDieTime( math.Rand( 0.1, 2.5 ) );

EFFECT.Mat = Material("effects/wk/spark_sharp")
EFFECT.Col1 = Color(255, 200, 150, 200) --Color(225,225,225,225)
EFFECT.Col2 = Color(255, 200, 150, 200)
EFFECT.Speed = 8192
...
function EFFECT:Think()
	...
	if self.Life > 1 then
		ParticleEffect( "wk_impact_bolter_mini_generic", self.EndPos, Angle(0,0,0) )
		return false
	end
...
function EFFECT:Render()
	...
	render.DrawBeam(startbeampos, endbeampos, 32, 0, 1, lerpedcol)
end

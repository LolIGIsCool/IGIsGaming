...
ENT.Spawnable = true
ENT.PrintName = "Star Wars Jetpack"
...
function ENT:Initialize()
	...
	if SERVER then
		self:SetModel( "models/clone_jetpack.mdl" )
		self:InitPhysics()

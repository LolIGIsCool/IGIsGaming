...
SWU.Changelog = {
    ...
    changes = {
        {
            type = "#",
            text = "Reworked addon code structure"
        },
        {
            type = "+",
            text = "Configuration menu (`swu_open_configuration`)"
        },
        {
            type = "+",
            text = "Configurable hyperspace speed"
        },
        {
            type = "+",
            text = "Configurable planet destruction"
        },
        {
            type = "+",
            text = "Configuration to enable the death star as a planet"
        },
        {
            type = "+",
            text = "Planet teleports for the Imperial Star Destroyer"
        },
        {
            type = "+",
            text = "Search function for the navigation computer"
        },
        {
            type = "#",
            text = "Orientation of the rotation display"
        },
        {
            type = "#",
            text = "Hook to add custom map configurations"
        },
        {
            type = "#",
        ...
        {
            type = "+",
            text = "Added missing planet Vardos"
        },
    }
}
SWU.Hyperspace = {
...
hook.Add("SWU_LoadCustomMapConfig", "SWU_AddOptionalDeathStarToMap", function ()
    ...
    local deathStarPos = Vector(-345, -685, 0)
    ...
    table.insert(SWU.Universe[deathStarChunk], {
        ...
        type = "model_object",
        baseScale = 0.08,
        model = "models/morganicism/empireatwar/death_starii/death_starii_mapsize02_modified.mdl"
    })
end)

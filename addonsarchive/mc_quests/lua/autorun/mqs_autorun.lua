...
MQS.Version = "1.2.0"
MQS.ServerID = "MQS77656119816210477901ID"
MQS.MainUserID = "76561198162104779"
MQS.DB = {}
...
if SERVER then
	...
	list.Set( "DesktopWindows", "QuestEditorSetup", {
		title		= "MQS",
		icon		= "mqs/logo64.png",
		width		= 960,
		height		= 700,
		...
		init		= function( icon, window )
			window:Close()
			icon.Window = MQS.OpenMenuManager(g_ContextMenu)
		end
	} )
end

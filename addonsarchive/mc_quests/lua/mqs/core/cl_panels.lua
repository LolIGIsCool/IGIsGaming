...
MSD.EventList["Manage do time"] = {
	...
	builUI = function(event, panel)
		...
		MSD.DTextSlider(panel, "static", nil, 1, 50, Ln("q_dotime_reset"), Ln("q_dotime_add"), data[1], function(self, value)
			data[1] = value
		end)

		MSD.TextEntry(panel, "static", nil, 1, 50, Ln("e_number"), Ln("timee_number_add") .. "(" .. Ln("in_sec") .. "):", data[2], function(self, value)

...
local enttablel = {"casinokit_chipnpc","casinokit_holdem"} 
function CasinoKit.restorePersistedEnts(ply)
	if ply and not ply:IsSuperAdmin() then return end
	for k,v in pairs(enttablel) do
...
concommand.Add("ckitreloadmap",CasinoKit.restorePersistedEnts)
...
local color1,color2,color3 = Color(0, 255, 0, 255),Color(255, 0, 0, 255),Color(0, 0, 0, 110)
...
local function HUDPaint()
    ...
    local col = FPP.canTouchEnt(LAEnt, touchType) and color1 or color2

    draw.RoundedBox(4, 0, ScrH() / 2 - h - 2, w + 10, 20, color3)

...
function RecieveColorMsg()
    ...
    if cond == "" then
        if v == target then
            chat.AddText( Color(255,255,255),"[",Color(255,255,0),"FSPECTATE",Color(255,255,255),"] ",TeamTable[targeter:Team()].Colour,targeter:Nick(),Color(255,255,255)," has started spectating ",Color(255,255,0),"YOU" )
        else
            chat.AddText( Color(255,255,255),"[",Color(255,255,0),"FSPECTATE",Color(255,255,255),"] ",TeamTable[targeter:Team()].Colour,targeter:Nick(),Color(255,255,255)," has started spectating ",TeamTable[target:Team()].Colour,target:Nick(),Color(255,255,255)," (",TeamTable[target:Team()].Colour,target:SteamID(),Color(255,255,255),")" )
        end
    elseif cond == "stop" then
        chat.AddText( Color(255,255,255),"[",Color(255,0,0),"FSPECTATE",Color(255,255,255),"] ",TeamTable[targeter:Team()].Colour,targeter:Nick(),Color(255,255,255)," has stopped spectating" )
    elseif cond == "start" then
        chat.AddText( Color(255,255,255),"[",Color(255,255,0),"FSPECTATE",Color(255,255,255),"] ",TeamTable[targeter:Team()].Colour,targeter:Nick(),Color(255,255,255)," has opened fspectate" )
    end
end

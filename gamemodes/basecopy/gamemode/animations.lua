...
local events = {
	[ PLAYERANIMEVENT_ATTACK_PRIMARY ] = function( ply, event, data )
	...
	[ PLAYERANIMEVENT_ATTACK_SECONDARY ] = function( ply, event, data )	
		return ACT_VM_SECONDARYATTACK
	end,
	[ PLAYERANIMEVENT_RELOAD ] = function( ply, event, data )
		if ply:Crouching() then
	...
	[ PLAYERANIMEVENT_JUMP ] = function( ply, event, data )	
		ply.m_bJumping = true
...
function GM:DoAnimationEvent( ply, event, data )
	if events[ event ] then return events[ event ]( ply, event, data ) end
end